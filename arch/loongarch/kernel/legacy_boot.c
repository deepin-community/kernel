...
#include "../../../drivers/irqchip/irq-loongson.h"
...
static void register_default_pic(int id, u32 address, u32 irq_base)
{
...
static int parse_screeninfo(struct _extention_list_hdr *head)
{
	...
	memcpy(&sysfb_primary_display.screen, &pscreeninfo->si,
...
static unsigned int bpi_init(void)
{
