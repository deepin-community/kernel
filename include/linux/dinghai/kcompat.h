 ...
 * 2.4 kernels (except for the red hat 2.4.21 kernels
 */
...
#ifdef CGS_V5_693
/* Function is implemented in kcompat.c */
...
#if !((KYLIN_RELEASE_CODE == KYLIN_RELEASE_VERSION(10,4) && !defined(HAVE_UOS_RELEASE_CODE)) || \
      (KYLIN_RELEASE_CODE != KYLIN_RELEASE_VERSION(10,4) && defined(HAVE_UOS_RELEASE_CODE)))
#define HAVE_TC_SETUP_CLSFLOWER
#endif/*KYLIN UOS*/
#define HAVE_TC_SETUP_CLSU32
#endif /* 4.6.0 */
...
static inline u32 _kc_get_random_u32(void)
{
	return get_random_int();
}

#undef get_random_u32
#define get_random_u32 _kc_get_random_u32
...
#define ida_alloc(ida, gfp) \
	ida_simple_get(ida, 0, 0, gfp)

/* IDA API compatibility: ida_alloc_range -> ida_simple_get */
#define ida_alloc_range(ida, start, end, gfp) \
	ida_simple_get(ida, start, end, gfp)

/* IDA API compatibility: ida_free -> ida_simple_remove */
#define ida_free(ida, id) \
	ida_simple_remove(ida, id)
#endif

#if (LINUX_VERSION_CODE >= KERNEL_VERSION(4,18,0) && LINUX_VERSION_CODE <= KERNEL_VERSION(5,4,119))
#if (LINUX_VERSION_CODE != KERNEL_VERSION(4,19,0))
#define NETDEVICE_OPS
#define NO_XA_FOR_EACH_RANGE
#define DEFAULT_GROUPS
#endif /* !=4.19.0 */
#if (RHEL_RELEASE_CODE == RHEL_RELEASE_VERSION(8,7))
#define HAVE_DEVLINK_REGISTER_GET_1_PARAMS
#undef HAVE_DEVLINK_ALLOC_GET_1_PARAMS
#undef NETDEVICE_OPS
#define HAVE_ETHTOOL_RING_PARAM
#define ETHTOOL_COALESCE_CFG
#define PCIE_VPD_STRUCT_COMPAT
#endif
...
#define ETH_MODULE_SFF_8436_MAX_LEN     640
#endif
#endif /* >=4.18.0 <=5.4.119 */

#if (defined(UBUNTU_V20_04_5) || defined(UBUNTU_V20_04_6) || defined(TENCENT_V3_2) || defined(TENCENT_V3_3))
#define NETDEVICE_OPS
#define NO_XA_FOR_EACH_RANGE
#endif /*
 * UBUNTU_V20_04_5 - linux(5.4.195)
 * UBUNTU_V20_04_6 - linux(5.4.199)
 * TENCENT_V3_2    - linux(5.4.241)
 */
...
/* kernel_write signature changed in 5.0: pos became loff_t* instead of loff_t */
#ifdef CGS_V5_693
/* #define kernel_write(file, buf, count, pos) \
 *     kernel_write(file, buf, count, *(pos))
 */
/* sysfs_get_dirent in 3.10.0 takes 3 params: (parent_sd, ns, name) */
#define sysfs_get_dirent(parent, name) \
    sysfs_get_dirent(parent, NULL, name)
/* kernfs_put was renamed to sysfs_put in older kernels */
#define kernfs_put sysfs_put
/* fallback function in 3.10.0 takes only 2 params (dev, skb) */
#define fallback(dev, skb, ...) fallback(dev, skb)
/* struct rhltable and struct rhashtable for 3.10.0 */
#ifndef _LINUX_RHASHTABLE_H
#include <linux/rhashtable.h>
#endif
#ifdef _LINUX_RHASHTABLE_H
/* rhashtable types already provided by linux/rhashtable.h */
#define _CGS_RHASH_HEAD_DEFINED
#define _CGS_BUCKET_TABLE_DEFINED
#define _CGS_RHASHTABLE_PARAMS_DEFINED
#define _CGS_RHASHTABLE_DEFINED
#define _CGS_RHLTABLE_DEFINED
#else
#ifndef _CGS_RHASH_HEAD_DEFINED
#define _CGS_RHASH_HEAD_DEFINED
struct rhash_head {
    struct rhash_head __rcu *next;
};
#endif
#ifndef _CGS_BUCKET_TABLE_DEFINED
#define _CGS_BUCKET_TABLE_DEFINED
struct bucket_table {
    unsigned int            size;
    unsigned int            rehash;
...
#endif
#ifndef _CGS_RHASHTABLE_PARAMS_DEFINED
#define _CGS_RHASHTABLE_PARAMS_DEFINED
...
#endif
#ifndef _CGS_RHASHTABLE_DEFINED
#define _CGS_RHASHTABLE_DEFINED
struct rhashtable {
...
/* flow_action_entry for 3.10.0 - struct not available in older kernels */
#ifndef HAVE_STRUCT_FLOW_ACTION_ENTRY
#define HAVE_STRUCT_FLOW_ACTION_ENTRY
#ifndef FLOW_ACTION_MANGLE
#define FLOW_ACTION_MANGLE      5
#endif
#ifndef FLOW_ACT_MANGLE_UNSPEC
#define FLOW_ACT_MANGLE_UNSPEC  0
#endif
#ifndef FLOW_ACT_MANGLE_HDR_TYPE_ETH
#define FLOW_ACT_MANGLE_HDR_TYPE_ETH  1
#endif
#ifndef FLOW_ACT_MANGLE_HDR_TYPE_IP4
#define FLOW_ACT_MANGLE_HDR_TYPE_IP4  2
#endif
#ifndef FLOW_ACT_MANGLE_HDR_TYPE_IP6
#define FLOW_ACT_MANGLE_HDR_TYPE_IP6  3
#endif
#ifndef FLOW_ACT_MANGLE_HDR_TYPE_TCP
#define FLOW_ACT_MANGLE_HDR_TYPE_TCP  4
#endif
#ifndef FLOW_ACT_MANGLE_HDR_TYPE_UDP
#define FLOW_ACT_MANGLE_HDR_TYPE_UDP  5
#endif
struct flow_action_entry_mangle {
    u32     mask;
    u32     val;
    u32     offset;
    u16     htype;
...
struct flow_action_entry {
    u16                             id;
    struct flow_action_entry_mangle mangle;
};
#endif /* HAVE_STRUCT_FLOW_ACTION_ENTRY */

#ifndef bpf_prog_put
#define bpf_prog_put(prog) do {} while (0)
#endif

/* virt_mb/virt_rmb for 3.10.0 - not available in older kernels */
#ifndef virt_mb
#define virt_mb() mb()
#endif
#ifndef virt_rmb
...
/* page_to_virt and related macros for 3.10.0 */
#ifndef __va
...
/* virt_store_mb/virt_load_mb for 3.10.0 - not available */
#ifndef virt_store_mb
#define virt_store_mb(var, val)  do { (var) = (val); mb(); } while (0)
#endif
#ifndef virt_load_mb
#define virt_load_mb(var)        ({ mb(); (var); })
#endif
...
#ifndef CTYUNOS_4_19_5_10
#if ((RHEL_RELEASE_CODE != RHEL_RELEASE_VERSION(8,7)) && (RHEL_RELEASE_CODE != RHEL_RELEASE_VERSION(8,6)))
#if (KYLIN_RELEASE_CODE != KYLIN_RELEASE_VERSION(10,4))
...
#if ((LINUX_VERSION_CODE >= KERNEL_VERSION(5,13,0)) || defined(CONFIG_CGSL_ETHTOOL))
#define HAVE_ETHTOOL_GET_MODULE_EEPROM_BY_PAGE
#endif

#if (LINUX_VERSION_CODE == KERNEL_VERSION(5,14,0))
#if (RHEL_RELEASE_CODE && (RHEL_RELEASE_CODE == RHEL_RELEASE_VERSION(9,2)))
#define ZXDH_ADAPT_REDHAT_9_2
#define HAVE_VFS_MKDIR
#define HAVE_ETHTOOL_RING_PARAM
#define ETHTOOL_COALESCE_CFG
#define PCIE_VPD_STRUCT_COMPAT
#endif
...
#if (RHEL_RELEASE_CODE && (RHEL_RELEASE_CODE == RHEL_RELEASE_VERSION(9,3)))
#define Rocky_9_3
#define HAVE_USE_STDARG_HEADER
#define HAVE_BUS_TYPE_REMOVE_RETURN_VOID
#define AUX_BUS_TYPE_REMOVE_RETURN_VOID
#define HAVE_DEVLINK_REGISTER_GET_1_PARAMS
#define USE_PRIV_IOCTL
#undef HAVE_DEVLINK_ALLOC_GET_1_PARAMS
#define ETHTOOL_COALESCE_CFG
#define HAVE_VFS_MKDIR
#define HAVE_ETHTOOL_RING_PARAM
...
#define ZXDH_ADAPT_REDHAT_9_6
#define HAVE_USE_STDARG_HEADER
#define USE_FLAG_SET_FUNC
#define HAVE_NO_MODULE_PARAM
#define PCIE_VPD_STRUCT_COMPAT
#define HAVE_BUS_TYPE_REMOVE_RETURN_VOID
#define HAVE_DEVLINK_REGISTER_GET_1_PARAMS
#undef HAVE_DEVLINK_ALLOC_GET_1_PARAMS
#define HAVE_CONST_DEVICE
#define AUX_BUS_TYPE_REMOVE_RETURN_VOID
#define ETHTOOL_COALESCE_CFG
#define HAVE_ETHTOOL_RING_PARAM
#define HAVE_ETHTOOL_GSRSSH
#define HAVE_VFS_MKDIR_NO_IDMAP
#define USE_PRIV_IOCTL
static inline int pci_enable_pcie_error_reporting(struct pci_dev __always_unused *dev)
{
  return 0;
...
#if (LINUX_VERSION_CODE == KERNEL_VERSION(5,15,136)) || (LINUX_VERSION_CODE == KERNEL_VERSION(5,15,160)) || (LINUX_VERSION_CODE == KERNEL_VERSION(5,15,163)) || \
    (LINUX_VERSION_CODE == KERNEL_VERSION(5,15,0)) || (LINUX_VERSION_CODE == KERNEL_VERSION(5,15,180)) || (LINUX_VERSION_CODE == KERNEL_VERSION(5,15,167)) || \
    (LINUX_VERSION_CODE == KERNEL_VERSION(5,15,179)) || (LINUX_VERSION_CODE == KERNEL_VERSION(5,15,148)) || (LINUX_VERSION_CODE == KERNEL_VERSION(5,15,152))
#define HAVE_BUS_TYPE_REMOVE_RETURN_VOID
#define AUX_BUS_TYPE_REMOVE_RETURN_VOID
#define HAVE_DEVLINK_REGISTER_GET_1_PARAMS
#define USE_PRIV_IOCTL
...
#if (LINUX_VERSION_CODE == KERNEL_VERSION(6,6,25))
#define ZXDH_ADAPT_6_6
#endif

#if (LINUX_VERSION_CODE == KERNEL_VERSION(6,6,30)) || (LINUX_VERSION_CODE == KERNEL_VERSION(6,6,70))
#define ZXDH_ADAPT_6_6
#endif
...
#ifdef ZXDH_ADAPT_6_6
#define ZXDH_ADAPT_ANOLIS_6_6
#endif

/* Started by AICoder, pid:b74e1p2e5ft605414a490935b082df147138fc9f */
#if (LINUX_VERSION_CODE == KERNEL_VERSION(6,12,47))
#define ZXDH_ADAPT_6_12
#endif

#if (LINUX_VERSION_CODE == KERNEL_VERSION(6,13,0))
#define ZXDH_ADAPT_6_13
#endif

#if (LINUX_VERSION_CODE == KERNEL_VERSION(6,6,98)) || (LINUX_VERSION_CODE == KERNEL_VERSION(6,12,47)) || (LINUX_VERSION_CODE == KERNEL_VERSION(6,6,102))
#define ZXDH_ADAPT_6_6
#define HAVE_USE_STDARG_HEADER
#define HAVE_BUS_TYPE_REMOVE_RETURN_VOID
#define AUX_BUS_TYPE_REMOVE_RETURN_VOID
#define NDO_FDB_DEL_HAVE_ACK_NO_MOD
#endif

#if defined (ZXDH_ADAPT_6_6) || defined (ZXDH_ADAPT_6_12) || defined (ZXDH_ADAPT_6_13)
#define USE_PRIV_IOCTL
#define HAVE_DEVLINK_REGISTER_GET_1_PARAMS
#undef HAVE_DEVLINK_ALLOC_GET_1_PARAMS
#define HAVE_VFS_MKDIR_NO_IDMAP
...
#define ETHTOOL_COALESCE_CFG
#define PCIE_VPD_STRUCT_COMPAT
#define NO_U64_STATS_FETCH_BEGIN_IRQ
#define USE_DEV_ADDR_SET
#define NETIF_NAPI_ADD_NO_WEIGHT
#define CLASS_CREATE_NO_MODULE
#define HAVE_VM_FLAGS_SET
#define HAVE_MEMBER_DEVICE_TYPE_CONST
/* Ended by AICoder, pid:b74e1p2e5ft605414a490935b082df147138fc9f */
...
/* Started by AICoder, pid:lb9f646851v071314e44083f00ee00106205270e */
#if defined (ZXDH_ADAPT_6_12) || defined (ZXDH_ADAPT_6_13)
#define DEVLINK_SAMEPLE_SET_HAVE_ACK
#define HAVE_USE_STDARG_HEADER
#define HAVE_BUS_TYPE_REMOVE_RETURN_VOID
#define AUX_BUS_TYPE_REMOVE_RETURN_VOID
#define AUXILIAR_MATCH_DRV_CONST
#define PCI_DEV_NOT_HAVE_SRIOV
#define HAVE_KERNEL_ETHTOOL_TS_INFO
#define HAVE_ETHTOOL_KEEE
#define HAVE_RXFH_HASHFUNC
#define ETHTOOL_USE_RXFH_PARAM
#define CHECK_DCB_ENABLED
#endif

#if defined (ZXDH_ADAPT_6_13)
#define NDO_FDB_HAVE_MODIFIED
#endif
/* Ended by AICoder, pid:lb9f646851v071314e44083f00ee00106205270e */

#define pci_disable_pcie_error_reporting(dev) do {} while (0)

#if (LINUX_VERSION_CODE == KERNEL_VERSION(5,10,0))
#if defined (CTYUNOS) || defined (OPENEULER_MAJOR)
#define ZXDH_CTYUNOS_5_10_0
#define HAVE_ETHTOOL_RING_PARAM
#define ETHTOOL_COALESCE_CFG
#elif defined (CULINUX_V3)
#define HAVE_ETHTOOL_RING_PARAM
#define ETHTOOL_COALESCE_CFG
#endif
#endif

#ifdef NO_XA_FOR_EACH_RANGE
/**
...
#if (KYLIN_RELEASE_CODE != KYLIN_RELEASE_VERSION(10,4))
static inline int unregister_netdevice_notifier_net(struct net *net,
				      struct notifier_block *nb)
{
	return unregister_netdevice_notifier(nb);
}

static inline int register_netdevice_notifier_net(struct net *net,
				      struct notifier_block *nb)
{
...
#if (LINUX_VERSION_CODE == KERNEL_VERSION(4,19,90) || LINUX_VERSION_CODE == KERNEL_VERSION(4,19,91))
#define IANA_VXLAN_UDP_PORT     4789
#endif

#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5,15,0))
#define HAVE_RB_TREE_OPS
#endif

#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5,10,0))
#define HAVE_TC_FLOW_OFFLOAD
#define FLOW_UPDATE_STAT_SIX_PARAMS
#else
#if (LINUX_VERSION_CODE == KERNEL_VERSION(4,19,0))
#define HAVE_TC_FLOW_OFFLOAD
#define FLOW_UPDATE_STAT_FIVE_PARAMS
#elif (LINUX_VERSION_CODE == KERNEL_VERSION(4,19,90)) || (LINUX_VERSION_CODE == KERNEL_VERSION(3,10,0))
#undef HAVE_TC_FLOW_OFFLOAD
#elif ((((LINUX_VERSION_CODE == KERNEL_VERSION(4,18,00)) && (RHEL_RELEASE_CODE >= RHEL_RELEASE_VERSION(8,6)))) \
        || defined (CTYUNOS_4_19_5_10))
#define HAVE_TC_FLOW_OFFLOAD
#define FLOW_UPDATE_STAT_SIX_PARAMS
#else
#define HAVE_TC_FLOW_OFFLOAD
...
#if (KYLIN_RELEASE_CODE && (KYLIN_RELEASE_CODE == KYLIN_RELEASE_VERSION(10,4)))//4.19.90
#define KYLIN_V10
#define HAVE_NDO_FDB_ADD_EXTACK
#define HAVE_NDO_BRIDGE_SETLINK_EXTACK
#endif
...
/*kylin_v11_2505_6.6*/
#if (KYLIN_RELEASE_CODE && (KYLIN_RELEASE_CODE == KYLIN_RELEASE_VERSION(11,0)))
#define KYLIN_V11_6_6
#define HAVE_BUS_TYPE_REMOVE_RETURN_VOID
#define HAVE_MEMBER_DEVICE_TYPE_CONST
#define HAVE_VFS_MKDIR_NO_IDMAP
#define HAVE_DEVLINK_REGISTER_GET_1_PARAMS
...
/* uos 5.10.0 */
#ifdef HAVE_UOS_RELEASE_CODE1
#define ETHTOOL_COALESCE_CFG
#define HAVE_ETHTOOL_RING_PARAM
#endif

#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5,7,0))
#define ZXDH_SKB_FLOW_KEYS_BASIC
#endif

#ifdef UBUNTU_V24_04_6
#define HAVE_USE_STDARG_HEADER
#define HAVE_BUS_TYPE_REMOVE_RETURN_VOID
#define HAVE_MEMBER_DEVICE_TYPE_CONST
#define PCIE_VPD_STRUCT_COMPAT
...
/*
 * CGS_V5_693 (RHEL 7.4 / 3.10.0-693) compatibility
 * skb_put_data() and skb_metadata_set() were added in later kernels
 * __ro_after_init is not available in 3.10 kernel
 */
#ifdef CGS_V5_693
/**
 * skb_put_data - Add data to skb and update tail pointer
 * @skb: buffer to add data to
 * @data: pointer to data to copy
 * @len: length of data to copy
 *
 * This function is not available in 3.10 kernel, provide compatibility version
 */
...
/**
 * skb_metadata_set - Set metadata size for skb
 * @skb: buffer to set metadata on
 * @meta_len: length of metadata
 *
 * This function is not available in 3.10 kernel, provide compatibility version
 * In 3.10 kernel, metadata is handled differently, so this is a no-op
 */
static inline void skb_metadata_set(struct sk_buff *skb, u32 meta_len)
{
    /* Metadata not supported in 3.10 kernel, skip */
}

/* __ro_after_init is not available in 3.10 kernel, use __read_mostly as alternative */
#ifndef __ro_after_init
#define __ro_after_init __read_mostly
#endif

/* PCI IRQ allocation flags - not defined in 3.10 kernel */
...
/*
 * For 3.10 kernel, pci_dev doesn't expose msix_entries and num_msix_vectors.
 * We provide compatibility implementations in kcompat.c
 */
#ifdef CGS_V5_693
/* These functions are implemented in kcompat.c to ensure a single global instance */
...
#define CONFIG_DINGHAI_ETH
#define CONFIG_ZXDH_AUXILIARY
#define CONFIG_DINGHAI_PF
#define CONFIG_ZXDH_SF
#define CONFIG_DINGHAI_EN_AUX
#define HAVE_DEV_PM_DOMAIN_ATTACH
#define HAVE_BUS_FIND_DEVICE_GET_CONST
#define CONFIG_DINGHAI_DH_CMD
#define CONFIG_DINGHAI_NP
#define CONFIG_ZXDH_MSGQ
#define CONFIG_ZXDH_HARDWARE_BOND
#define CONFIG_DINGHAI_PTP
#define CONFIG_DINGHAI_TSN

#define ZXDH_MSGQ
#ifndef PTP_DRIVER_INTERFACE_EN
