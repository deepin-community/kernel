...
static const struct soc_enum lp_src_enum = SOC_ENUM_SINGLE(SND_SOC_NOPM,
		0, ARRAY_SIZE(i2s_sc_loopback_src_text),
...
static int cdns_i2s_sc_probe(struct platform_device *pdev)
{
	...
	if (ACPI_COMPANION(&pdev->dev))
		 ...
		 * work in acpi initialize if you want request the dma channel.
