 ...
 * V1.21 - added gpio support of chip ch344
 * V1.22 - added support of chip ch347
 *
 */
...
#define VERSION_DESC 			"V1.22 On 2022.05.17"
...
/*
 * Functions for CH343 bulk messages.
 */
// static int ch343_bulk_out(struct ch343 *ch343, u8 *buf,
//                           int count)
// {
// 	int retval, actual_len;

// 	retval = usb_bulk_msg(ch343->dev, ch343->cmdtx_endpoint,
// 	                      buf,
// 	                      min((unsigned int)count, ch343->cmdsize),
...
// 	if (actual_len != count) {
// 		dev_err(&ch343->data->dev, "only wrote %d of %d bytes\n",
// 		        actual_len, count);
// 		return -1;
// 	}
...
// static int ch343_bulk_in(struct ch343 *ch343, u8 *buf,
//                           int count)
// {
// 	int retval, actual_len;

// 	retval = usb_bulk_msg(ch343->dev, ch343->cmdrx_endpoint,
// 	                      buf,
// 	                      min((unsigned int)count, ch343->cmdsize),
// 	                      &actual_len, DEFAULT_TIMEOUT);
...
// 	if (actual_len != count) {
// 		dev_err(&ch343->data->dev, "only read %d of %d bytes\n",
// 		        actual_len, count);
// 		return -1;
// 	}
