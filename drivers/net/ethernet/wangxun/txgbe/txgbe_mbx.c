 ...
 **/
static int txgbe_check_for_msg_vf(struct txgbe_hw *hw, u16 __always_unused mbx_id)
{
	int err = TXGBE_ERR_MBX;
 ...
 **/
static int txgbe_check_for_ack_vf(struct txgbe_hw *hw, u16 __always_unused mbx_id)
{
	int err = TXGBE_ERR_MBX;
 ...
 **/
static int txgbe_check_for_rst_vf(struct txgbe_hw *hw, u16 __always_unused mbx_id)
{
	int err = TXGBE_ERR_MBX;
