...
#define NGBE_VF_LINK_STATE_DISABLE 0
#define NGBE_VF_LINK_STATE_AUTO 1
#define NGBE_VF_LINK_STATE_ENABLE 2
...
int ngbe_ndo_set_vf_vlan(struct net_device *netdev, int queue, u16 vlan, u8 qos, __be16 vlan_proto);
#else
int ngbe_ndo_set_vf_vlan(struct net_device *netdev, int queue, u16 vlan, u8 qos);
#endif
int ngbe_ndo_set_vf_bw(struct net_device *netdev, int vf, int min_tx_rate, int max_tx_rate);
