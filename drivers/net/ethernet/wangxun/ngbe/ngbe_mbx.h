...
#define NGBE_VT_MSGTYPE_CTS    0x20000000 /* Indicates that VF is still
					   ...
					   */
#define NGBE_VT_MSGTYPE_NRN    0x10000000 /* Indicates that PF is not running */
#define NGBE_VT_MSGINFO_SHIFT  16
#define NGBE_VT_MSGINFO_VLAN_OFFLOAD_SHIFT  17
...
#define NGBE_VF_GET_LINK_STATE 0x10 /* get vf link state */
#define NGBE_VF_BACKUP		0x8001 /* VF requests backup */
#define NGBE_VF_GET_FW_VERSION 0x11 /* get fw version */
...
#define NGBE_VF_MBX_INIT_TIMEOUT       3000 /* number of retries on mailbox */
#define NGBE_VF_MBX_INIT_DELAY         50  /* microseconds between retries */
