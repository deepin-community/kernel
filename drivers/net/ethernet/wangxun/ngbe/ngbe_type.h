...
#define NGBE_EX_PHY 0x0090
#define NGBE_PHY_MIX 0x00A0
...
/* yt8521s reg */
#define NGBE_YT_PHY_ID_MATCH_MODEL_SHIFT 4
#define NGBE_YT8521S_PHY_ID_MATCH_MODEL 0x011
#define NGBE_YT8531S_PHY_ID_MATCH_MODEL 0xe91
#define NGBE_SK21101_PHY_ID_MATCH_MODEL 0x201
...
/**************** external phy *******************/
#define NGBE_EXPHY_MII_BMCR 0x00 /* Basic mode control register */
#define NGBE_EXPHY_MII_BMSR 0x01 /* Basic mode status register */
#define RTL821x_INER 0x12 /* Interrupt enable register */
#define RTL821x_PHYSR 0x1a /* Specific Status register */
#define RTL821x_INSR 0x1d /* Interrupt status register */
#define RTL821x_PAGE_SELECT 0x1f
#define RTL8211F_FIBER_ESR 0x0f /* fiber extended status register */

#define NGBE_EXPHY_BMCR_PDOWN 0x0800 /* Enable low power state */
#define NGBE_EXPHY_BMCR_RESET 0x8000
#define RTL8211F_INSR_LINK_STATUS BIT(4)
#define RTL8211F_INER_LINK_CHANGE BIT(4)
#define RTL8211F_ANC_STATUS BIT(3)
#define NGBE_88E1111_ANC BIT(11)
#define NGBE_88E1111_LINK_CHANGE BIT(10)
#define NGBE_88E1111_LINK_CHANGE_STATUS BIT(10)

#define NGBE_88E1111_INER 0x12 /* Interrupt enable register */
#define NGBE_88E1111_INSR 0x13 /* Interrupt status register */
#define NGBE_88E1111_ESCR 0x14 /* Extended PHY Specific Control Register */

#define NGBE_RTL8211F_PHY_ID2 0xc916
#define NGBE_RTL8211F_PHY_ID1 0x001c
#define NGBE_JL2201_PHY_ID2 0x4032
#define NGBE_JL2201_PHY_ID1 0x937c
#define NGBE_YT8011A_PHY_ID2 0xeb01
#define NGBE_YT8011A_PHY_ID1 0x4f51
#define NGBE_88E1111_PHY_ID2 0x0CC0
#define NGBE_88E1111_PHY_ID1 0x0141
#define RTL8211F_TX_DELAY BIT(8)
#define RTL8211F_RX_DELAY BIT(3)
#define JL2201_TX_DELAY BIT(8)
#define JL2201_RX_DELAY BIT(9)
#define NGBE_YT8011A_INSR_LINK_STATUS BIT(7)
#define NGBE_PHY_BMCR_PDOWN 0x0800 /* Enable low power state */
#define NGBE_PHY_BMCR_RESET 0x8000 /* Enable low power state */
#define NGBE_88E1111_TX_DELAY BIT(7)
#define NGBE_88E1111_RX_DELAY BIT(1)
...
/* in external phy ncsi fw, this reg use to notify fw link status */
...
#define NGBE_TDM_VFTE_CLR 0x180A0
...
#define NGBE_TDM_DESC_CHK 0x180B0
#define NGBE_TDM_DESC_NONFATAL 0x180C0
...
#define NGBE_TDM_VLAN_INS_TPID_SEL_SHIFT 24 /*Tag tpid sel*/
...
#define NGBE_RDM_VFRE_CLR 0x120A0
...
#define NGBE_PSR_DBG_DRP_CNT 0x151C0
...
#define NGBE_TSC_LSEC_PKTNUM0 0x1D214

#define NGBE_TSC_LSEC_PKTNUM1 \
	0x1D218 /*This reg is used by fw to tell drv not to drv rst*/
...
#define NGBE_TSEC_1588_INT_ST_TT0 0x10
#define NGBE_TSEC_1588_INT_ST_TT1 0x20
#define NGBE_TSEC_1588_INT_EN_TT0 0x10
#define NGBE_TSEC_1588_INT_EN_TT1 0x20

#define NGBE_TSEC_1588_AUX_CTL_EN_TT0 0x1
#define NGBE_TSEC_1588_AUX_CTL_PLSG 0x2
#define NGBE_TSEC_1588_AUX_CTL_EN_TT1 0x4
#define NGBE_TSEC_1588_AUX_CTL_EN_TS0 0x100
#define NGBE_TSEC_1588_AUX_CTL_EN_TS1 0x400

#define NGBE_TSEC_1588_SDP_FUN_SEL_TT0 0x1
#define NGBE_TSEC_1588_SDP_FUN_SEL_TT1 0x2
#define NGBE_TSEC_1588_SDP_FUN_SEL_CL0 0x3
#define NGBE_TSEC_1588_SDP_FUN_SEL_CL1 0x4
#define NGBE_TSEC_1588_SDP_FUN_SEL_TS0 0x5
#define NGBE_TSEC_1588_SDP_FUN_SEL_TS1 0x6
#define NGBE_TSEC_1588_SDP_FUN_SEL_MASK 0x7
#define NGBE_TSEC_1588_SDP_OUT_LEVEL_LOW 0x10
#define NGBE_TSEC_1588_SDP_OUT_LEVEL_HIGH 0x0
...
#define NGBE_PX_MISC_IC_TXDESC 0x00400000U /* tx desc error */
...
#define NGBE_PX_MISC_IEN_TXDESC 0x00400000U
...
#define NGBE_PX_MISC_IEN_MASK                                      \
	(NGBE_PX_MISC_IEN_ETH_LKDN | NGBE_PX_MISC_IEN_DEV_RST |    \
	 NGBE_PX_MISC_IEN_ETH_EVENT | NGBE_PX_MISC_IEN_ETH_LK |    \
	 NGBE_PX_MISC_IEN_ETH_AN | NGBE_PX_MISC_IEN_INT_ERR |      \
	 NGBE_PX_MISC_IEN_VF_MBOX | NGBE_PX_MISC_IEN_GPIO |        \
	 NGBE_PX_MISC_IEN_MNG_HOST_MBOX | NGBE_PX_MISC_IEN_STALL | \
...
#define NGBE_RXD_IPV6EX 0x00001000U /* IPv6EX  */
...
enum ngbe_l2_ptypes {
	...
	NGBE_PTYPE_L2_IPV6 =
		(NGBE_PTYPE_PKT_IP | NGBE_PTYPE_PKT_IPV6 | NGBE_PTYPE_TYP_IP),
	NGBE_PTYPE_L2_IPV6_UDP =
		(NGBE_PTYPE_PKT_IP | NGBE_PTYPE_PKT_IPV6 | NGBE_PTYPE_TYP_UDP),
	NGBE_PTYPE_L2_IPV6_TCP =
		(NGBE_PTYPE_PKT_IP | NGBE_PTYPE_PKT_IPV6 | NGBE_PTYPE_TYP_TCP),
	NGBE_PTYPE_L2_IPV6_SCTP =
		(NGBE_PTYPE_PKT_IP | NGBE_PTYPE_PKT_IPV6 | NGBE_PTYPE_TYP_SCTP),

	NGBE_PTYPE_L2_FCOE = (NGBE_PTYPE_PKT_FCOE | NGBE_PTYPE_TYP_FCOE),
	NGBE_PTYPE_L2_FCOE_FCDATA =
		(NGBE_PTYPE_PKT_FCOE | NGBE_PTYPE_TYP_FCDATA),
	NGBE_PTYPE_L2_FCOE_FCRDY = (NGBE_PTYPE_PKT_FCOE | NGBE_PTYPE_TYP_FCRDY),
	NGBE_PTYPE_L2_FCOE_FCRSP = (NGBE_PTYPE_PKT_FCOE | NGBE_PTYPE_TYP_FCRSP),
	NGBE_PTYPE_L2_FCOE_FCOTHER =
		(NGBE_PTYPE_PKT_FCOE | NGBE_PTYPE_TYP_FCOTHER),
	NGBE_PTYPE_L2_FCOE_VFT = (NGBE_PTYPE_PKT_FCOE | NGBE_PTYPE_PKT_VFT),
	NGBE_PTYPE_L2_FCOE_VFT_FCDATA =
		(NGBE_PTYPE_PKT_FCOE | NGBE_PTYPE_PKT_VFT |
		 NGBE_PTYPE_TYP_FCDATA),
	NGBE_PTYPE_L2_FCOE_VFT_FCRDY =
		(NGBE_PTYPE_PKT_FCOE | NGBE_PTYPE_PKT_VFT |
		 NGBE_PTYPE_TYP_FCRDY),
	NGBE_PTYPE_L2_FCOE_VFT_FCRSP =
		(NGBE_PTYPE_PKT_FCOE | NGBE_PTYPE_PKT_VFT |
		 NGBE_PTYPE_TYP_FCRSP),
	NGBE_PTYPE_L2_FCOE_VFT_FCOTHER =
		(NGBE_PTYPE_PKT_FCOE | NGBE_PTYPE_PKT_VFT |
...
#define NGBE_DV_X540(_max_frame_link, _max_frame_tc)                     \
	((36 *                                                           \
		  (NGBE_B2BT(_max_frame_link) + NGBE_PFC_D +             \
		   (2 * NGBE_CABLE_DC) + (2 * NGBE_ID_X540) + NGBE_HD) / \
		  25 +                                                   \
	  1) +                                                           \
...
#define NGBE_DV(_max_frame_link, _max_frame_tc)                     \
	((36 *                                                      \
		  (NGBE_B2BT(_max_frame_link) + NGBE_PFC_D +        \
		   (2 * NGBE_CABLE_DC) + (2 * NGBE_ID) + NGBE_HD) / \
		  25 +                                              \
	  1) +                                                      \
	 2 * NGBE_B2BT(_max_frame_tc))
...
#define NGBE_LOW_DV(_max_frame_tc) (2 * NGBE_LOW_DV_X540(_max_frame_tc))
...
struct ngbe_eeprom_operations {
	int (*init_params)(struct ngbe_hw *hw);
	int (*read)(struct ngbe_hw *hw, u16 offset, u16 *data);
	int (*read_buffer)(struct ngbe_hw *hw, u16 offset, u16 words, u16 *data);
	int (*read32)(struct ngbe_hw *hw, u16 offset, u32 *data);
	int (*write)(struct ngbe_hw *hw, u16 offset, u16 data);
	int (*write_buffer)(struct ngbe_hw *hw, u16 offset, u16 words, u16 *data);
	int (*validate_checksum)(struct ngbe_hw *hw, u16 *checksum_val);
	int (*update_checksum)(struct ngbe_hw *hw);
	int (*calc_checksum)(struct ngbe_hw *hw);
	int (*eeprom_chksum_cap_st)(struct ngbe_hw *hw, u16 offset, u32 *data);
	int (*phy_led_oem_chk)(struct ngbe_hw *hw, u32 *data);
	int (*phy_signal_set)(struct ngbe_hw *hw);
};

struct ngbe_flash_operations {
	int (*init_params)(struct ngbe_hw *hw);
	int (*read_buffer)(struct ngbe_hw *hw, u32 offset, u32 dwords, u32 *data);
	int (*write_buffer)(struct ngbe_hw *hw, u32 offset, u32 dwords, u32 *data);
	int (*check_led_oem)(struct ngbe_hw *hw);
};

struct ngbe_mac_operations {
	int (*init_hw)(struct ngbe_hw *hw);
	int (*reset_hw)(struct ngbe_hw *hw);
	int (*start_hw)(struct ngbe_hw *hw);
	int (*clear_hw_cntrs)(struct ngbe_hw *hw);
	enum ngbe_media_type (*get_media_type)(struct ngbe_hw *hw);
	int (*get_mac_addr)(struct ngbe_hw *hw, u8 *mac_addr);
	int (*get_device_caps)(struct ngbe_hw *hw, u16 *device_caps);
	int (*stop_adapter)(struct ngbe_hw *hw);
	int (*get_bus_info)(struct ngbe_hw *hw);
	void (*set_lan_id)(struct ngbe_hw *hw);
	int (*enable_rx_dma)(struct ngbe_hw *hw, u32 regval);
	int (*disable_sec_rx_path)(struct ngbe_hw *hw);
	int (*enable_sec_rx_path)(struct ngbe_hw *hw);
	int (*acquire_swfw_sync)(struct ngbe_hw *hw, u32 mask);
	...
	int (*setup_link)(struct ngbe_hw *hw, u32 speed, bool need_restart_AN);
	int (*setup_mac_link)(struct ngbe_hw *hw, u32 speed, bool autoneg_wait_to_complete);
	int (*check_link)(struct ngbe_hw *hw, u32 *speed, bool *link_up,
			  bool link_up_wait_to_complete);
	int (*get_link_capabilities)(struct ngbe_hw *hw, u32 *speed, bool *autoneg);

	/* Packet Buffer manipulation */
	void (*setup_rxpba)(struct ngbe_hw *hw, int num_pb, u32 headroom, int strategy);

	/* LED */
	int (*led_on)(struct ngbe_hw *hw, u32 index);
	int (*led_off)(struct ngbe_hw *hw, u32 index);

	/* RAR, Multicast, VLAN */
	int (*set_rar)(struct ngbe_hw *hw, u32 index, u8 *addr, u64 pools, u32 enable_addr);
	int (*clear_rar)(struct ngbe_hw *hw, u32 index);
	int (*insert_mac_addr)(struct ngbe_hw *hw, u8 *addr, u32 vmdq);
	int (*set_vmdq)(struct ngbe_hw *hw, u32 rar, u32 pool);
	int (*set_vmdq_san_mac)(struct ngbe_hw *hw, u32 vmdq);
	int (*clear_vmdq)(struct ngbe_hw *hw, u32 rar, u32 vmdq);
	int (*init_rx_addrs)(struct ngbe_hw *hw);
	int (*update_uc_addr_list)(struct ngbe_hw *hw, u8 *addr_list, u32 addr_count,
				   ngbe_mc_addr_itr next);
	int (*update_mc_addr_list)(struct ngbe_hw *hw, u8 *mc_addr_list,
				   u32 mc_addr_count, ngbe_mc_addr_itr next,
				   bool clear);
	int (*enable_mc)(struct ngbe_hw *hw);
	int (*disable_mc)(struct ngbe_hw *hw);
	int (*clear_vfta)(struct ngbe_hw *hw);
	int (*set_vfta)(struct ngbe_hw *hw, u32 vlan, u32 vind, bool vlan_on);
	int (*set_vlvf)(struct ngbe_hw *hw, u32 vlan, u32 vind, bool vlan_on,
			bool *vfta_changed);
	int (*init_uta_tables)(struct ngbe_hw *hw);
	...
	/* Flow Control */
	int (*fc_enable)(struct ngbe_hw *hw);
	int (*setup_fc)(struct ngbe_hw *hw);

	/* Manageability interface */
	int (*set_fw_drv_ver)(struct ngbe_hw *hw, u8 maj, u8 min, u8 build, u8 sub);
	int (*get_thermal_sensor_data)(struct ngbe_hw *hw);
...
struct ngbe_phy_operations {
	int (*identify)(struct ngbe_hw *hw);
	int (*identify_sfp)(struct ngbe_hw *hw);
	int (*init)(struct ngbe_hw *hw);
	int (*reset)(struct ngbe_hw *hw);
	int (*read)(struct ngbe_hw *hw, int phy_addr, int regnum);
	int (*write)(struct ngbe_hw *hw, int phy_addr, int regnum, u16 value);
	int (*read_reg)(struct ngbe_hw *hw, u32 reg_offset, u32 page,
			u16 *phy_data);
	int (*write_reg)(struct ngbe_hw *hw, u32 reg_offset, u32 page, u16 phy_data);
	int (*read_reg_mdi)(struct ngbe_hw *hw, u32 reg_addr,
			    u32 device_type, u16 *phy_data);
	int (*write_reg_mdi)(struct ngbe_hw *hw, u32 reg_addr,
			     u32 device_type, u16 phy_data);
	u32 (*setup_link)(struct ngbe_hw *hw, u32 speed,
			  bool autoneg_wait_to_complete);
	int (*phy_suspend)(struct ngbe_hw *hw);
	int (*phy_resume)(struct ngbe_hw *hw);
	u32 (*phy_led_ctrl)(struct ngbe_hw *hw);
	int (*setup_internal_link)(struct ngbe_hw *hw);
	int (*check_overtemp)(struct ngbe_hw *hw);
	int (*check_event)(struct ngbe_hw *hw);
	int (*get_adv_pause)(struct ngbe_hw *hw, u8 *pause_bit);
	int (*get_lp_adv_pause)(struct ngbe_hw *hw, u8 *pause_bit);
	int (*set_adv_pause)(struct ngbe_hw *hw, u16 pause_bit);
	int (*setup_once)(struct ngbe_hw *hw);
};
...
struct ngbe_phy_info {
	...
	enum ngbe_phy_device_type phydev_type;
	u32 addr;
	u32 id;
...
enum ngbe_reset_type { NGBE_LAN_RESET = 0, NGBE_SW_RESET, NGBE_GLOBAL_RESET };
...
struct ngbe_hw {
	...
	u16 oem_ssid;
	u16 oem_svid;
	spinlock_t phy_lock; /*used to prevent access phy at same time*/
	u32 q_tx_regs[512];
};
...
#define NGBE_YT_PHY_UNI_MODE 0xff020
...
static inline u32 ngbe_rd32(u8 __iomem *base)
{
	return readl(base);
}
...
/* write register */
static inline void ngbe_wr32(u8 __iomem *base, u32 val)
{
	writel(val, base);
}
...
static inline int po32m(struct ngbe_hw *hw, u32 reg, u32 mask, u32 field,
			int usecs, int count)
{
	int loop;
