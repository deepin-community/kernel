...
ZXIC_UINT32 dpp_tbl_roce_match_add(DPP_PF_INFO_T* pf_info, ZXIC_UINT32 sdt_no, ZXDH_ROCE_MATCH_T* pData)
{
...
EXPORT_SYMBOL(dpp_tbl_roce_match_add);

ZXIC_UINT32 dpp_tbl_roce_match_del(DPP_PF_INFO_T* pf_info, ZXIC_UINT32 sdt_no, ZXDH_ROCE_MATCH_T* pData)
{
    ZXIC_UINT32 rc = DPP_OK;
    ZXIC_UINT32 queue = 0;
    DPP_DEV_T dev = {0};
...
EXPORT_SYMBOL(dpp_tbl_roce_match_del);

ZXIC_UINT32 dpp_tbl_roce_match_search(DPP_PF_INFO_T* pf_info, ZXIC_UINT32 sdt_no, ZXDH_ROCE_MATCH_T* pData)
{
    ZXIC_UINT32 rc = DPP_OK;
    ZXIC_UINT32 queue = 0;
    DPP_DEV_T dev = {0};
...
EXPORT_SYMBOL(dpp_tbl_roce_match_search);
