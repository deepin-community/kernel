...
ZXIC_UINT32 dpp_tbl_qp_info_add(DPP_PF_INFO_T* pf_info, ZXIC_UINT32 sdt_no, ZXDH_QP_INFO_T* pData)
{
...
EXPORT_SYMBOL(dpp_tbl_qp_info_add);

ZXIC_UINT32 dpp_tbl_qp_info_del(DPP_PF_INFO_T* pf_info, ZXIC_UINT32 sdt_no, ZXDH_QP_INFO_T* pData)
{
    ZXIC_UINT32 rc = DPP_OK;
    ZXIC_UINT32 queue = 0;
    DPP_DEV_T dev = {0};
...
EXPORT_SYMBOL(dpp_tbl_qp_info_del);

ZXIC_UINT32 dpp_tbl_qp_info_search(DPP_PF_INFO_T* pf_info, ZXIC_UINT32 sdt_no, ZXDH_QP_INFO_T* pData)
{
    ZXIC_UINT32 rc = DPP_OK;
    ZXIC_UINT32 queue = 0;
    DPP_DEV_T dev = {0};
...
EXPORT_SYMBOL(dpp_tbl_qp_info_search);
