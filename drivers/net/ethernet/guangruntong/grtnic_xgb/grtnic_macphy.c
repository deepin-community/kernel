...
static void grtnic_i2c_bus_clear(struct grtnic_hw *hw);
static s32 grtnic_read_i2c_byte(struct grtnic_hw *hw, u8 byte_offset, u8 dev_addr, u8 *data);
...
void grtnic_SetTx(struct net_device *netdev, int onoff)
{
	...
	RegTc |= (XXGE_TC_DIC_MASK | XXGE_TC_VLAN_MASK); //Deficit Idle Count & VLAN Enable
...
void grtnic_SetRx(struct net_device *netdev, int onoff)
{
	...
	RegRcw1 |= XXGE_RCW1_VLAN_MASK;	//VLAN Enable
...
void grtnic_PhySetMdioDivisor(struct net_device *netdev, u8 Divisor)
{
	...
	GRTNIC_WRITE_REG(hw, (BaseAddr + XXGE_MDIO_CFG0_OFFSET),
		((u32)Divisor | XXGE_MDIO_CFG0_MDIOEN_MASK), 0);
}

//only for 10G phy
void grtnic_SetPhyAddr(struct net_device *netdev, u32 Prtad, u32 Devad, u32 RegisterNum)
{
	struct grtnic_adapter *adapter  = netdev_priv(netdev);
	struct grtnic_hw *hw = &adapter->hw;
...
//////////////////////////////////////////////////////////////////////////////////////////////
	...
	mdio_cfg1_op_read_mask = (max_speed == 1) ? XXGE_MDIO_CFG1_OP_READ_MASK_10G :
...
//////////////////////////////////////////////////////////////////////////////////////////////
	...
	GRTNIC_WRITE_REG(hw, (BaseAddr + XXGE_MDIO_TX_DATA_OFFSET),
		(PhyData & XXGE_MDIO_TX_DATA_MASK), 0);
	GRTNIC_WRITE_REG(hw, (BaseAddr + XXGE_MDIO_CFG1_OFFSET),
		MdioCtrlReg, 0);
	/**
	 * Wait till MDIO transaction is completed.
	 */
