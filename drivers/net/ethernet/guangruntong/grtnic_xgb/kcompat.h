...
#define pci_enable_msi(a) ((void)(a), -EOPNOTSUPP)
#undef pci_disable_msi
#define pci_disable_msi(a) ((void)(a))
#undef pci_enable_msix
#define pci_enable_msix(a, b, c) ((void)(a), (void)(b), (void)(c), -EOPNOTSUPP)
#undef pci_disable_msix
#define pci_disable_msix(a) ((void)(a))
#define msi_remove_pci_irq_vectors(a) ((void)(a))
...
/* if we do not have the infrastructure to detect if skb_header is
 * cloned just return false in all cases
 */
...
#define vlan_gro_receive(_napi, _vlgrp, _vlan, _skb) \
		((void)(_napi), vlan_hwaccel_receive_skb(_skb, _vlgrp, _vlan))
#define napi_gro_receive(_napi, _skb) \
		((void)(_napi), netif_receive_skb(_skb))
#endif
...
#define dca3_get_tag(a, b) ((void)(a), dca_get_tag(b))
#endif
...
#define IS_ENABLED(CONFIG_option) \
	(config_enabled(CONFIG_option) || config_enabled(CONFIG_option##_MODULE))
...
#endif
#define SLE_VERSION_CODE SLE_VERSION(CONFIG_SUSE_VERSION, CONFIG_SUSE_PATCHLEVEL, \
...
u64 _kc_pci_map_page(struct pci_dev *dev, struct page *page, unsigned long offset,
...
#define pdev_printk(lvl, pdev, fmt, args...)	\
	pr_info("%s %s: " fmt, lvl, pci_name(pdev), ## args)
...
#define dma_alloc_coherent(dev, sz, dma, gfp) \
	((void)(gfp), pci_alloc_consistent(to_pci_dev(dev), (sz), (dma)))
...
#define cancel_work_sync(x) ((void)(x), flush_scheduled_work())
#endif /* 2.5.28 => 2.4.17 */
...
/* Fallback memory barrier for pre-2.6.0 kernels */
...
#define dma_set_coherent_mask(dev, mask) ((void)(dev), (void)(mask), 1)
...
uint32_t _kc__div64_32(u64 *dividend, uint32_t divisor);
# define do_div(n, base) ({				\
	u32 __base = (base);			\
	u32 __rem;					\
	if (likely(((n) >> 32) == 0)) {			\
...
#define num_online_nodes(n) ((void)(n), 1)
...
#define pci_choose_state(pdev, state) ((void)(pdev), (state))
#define PMSG_SUSPEND 3
...
#define kfree_rcu(_ptr, _offset) ((void)(_offset), kfree(_ptr))
#endif /* kfree_rcu */
#ifndef vmalloc_node
#define vmalloc_node(a, b) ((void)(b), vmalloc(a))
#endif /* vmalloc_node*/
...
#define device_can_wakeup(dev)	((void)(dev), 1)
#endif
#ifndef device_set_wakeup_enable
#define device_set_wakeup_enable(dev, val)	do { (void)(dev); (void)(val); } while (0)
#endif
#ifndef device_init_wakeup
#define device_init_wakeup(dev, val) do { (void)(dev); (void)(val); } while (0)
#endif
...
static inline int _kc_request_irq(unsigned int irq, new_handler_t handler, unsigned long flags,
...
#endif
#define pci_cleanup_aer_uncorrect_error_status(dev) ((void)(dev))
...
#define dev_to_node(dev) ((void)(dev), -1)
#undef set_dev_node
/* remove compiler warning with b=b, for unused variable */
//#define set_dev_node(a, b) do { (b) = (b); } while (0)
/* remove compiler warning with (void), for unused variable */
#define set_dev_node(a, b) ((void)(a), (void)(b))
...
#define pci_request_selected_regions(pdev, bars, name) \
	((void)(bars), pci_request_regions(pdev, name))
#define pci_release_selected_regions(pdev, bars) ((void)(bars), pci_release_regions(pdev))
...
#define alloc_etherdev_mq(_a, _b) ((void)(_b), alloc_etherdev(_a))
#endif
...
#define SET_MODULE_OWNER(dev) ((void)(dev))
#endif /* > 2.6.22 */
...
#else
#define napi_synchronize(n)	((void)(n), barrier())
#endif /* CONFIG_SMP */
...
#define netif_napi_del(_a) ((void)(_a))
#endif /* NAPI */

#undef dev_get_by_name
#define dev_get_by_name(_a, _b) ((void)(_a), dev_get_by_name(_b))
...
#define pm_qos_add_requirement(pm_qos_class, name, value) \
		((void)(pm_qos_class), set_acceptable_latency(name, value))
#define pm_qos_remove_requirement(pm_qos_class, name) \
		((void)(pm_qos_class), remove_acceptable_latency(name))
#define pm_qos_update_requirement(pm_qos_class, name, value) \
		((void)(pm_qos_class), modify_acceptable_latency(name, value))
#else
#define PM_QOS_DEFAULT_VALUE	-1
#define pm_qos_add_requirement(pm_qos_class, name, value) \
	((void)(pm_qos_class), (void)(name), (void)(value))
#define pm_qos_remove_requirement(pm_qos_class, name) \
	((void)(pm_qos_class), (void)(name))
#define pm_qos_update_requirement(pm_qos_class, name, value) { \
	(void)(pm_qos_class); \
	(void)(name); \
	if (value != PM_QOS_DEFAULT_VALUE) { \
		pr_warn("%s: unable to set PM QoS requirement\n", \
...
#endif /* clamp_t */
#undef kzalloc_node
#define kzalloc_node(_size, _flags, _node) ((void)(_node), kzalloc(_size, _flags))
...
#endif
#define dma_mapping_error(dev, dma_addr) ((void)(dev), pci_dma_mapping_error(dma_addr))
...
#ifdef HAVE_TX_MQ
void _kc_netif_tx_stop_all_queues(struct net_device *ndev);
void _kc_netif_tx_wake_all_queues(struct net_device *ndev);
void _kc_netif_tx_start_all_queues(struct net_device *ndev);
...
#else
#define netif_tx_start_all_queues(a) ((void)(a))
#endif
#define netif_stop_subqueue(_ndev, _qi) ((void)(_qi), netif_stop_queue((_ndev)))
#define netif_start_subqueue(_ndev, _qi) ((void)(_qi), netif_start_queue((_ndev)))
#endif /* HAVE_TX_MQ */
#ifndef NETIF_F_MULTI_QUEUE
#define NETIF_F_MULTI_QUEUE 0
#define netif_is_multiqueue(a) ((void)(a), 0)
#define netif_wake_subqueue(a, b) ((void)(a), (void)(b))
#endif /* NETIF_F_MULTI_QUEUE */
...
#define netdev_alloc_page(a) ((void)(a), alloc_page(GFP_ATOMIC))
...
#define skb_rx_queue_recorded(a) ((void)(a), false)
#define skb_get_rx_queue(a) ((void)(a), 0)
#define skb_record_rx_queue(a, b) do { (void)(a); (void)(b); } while (0)
#define skb_tx_hash(n, s) ___kc_skb_tx_hash((n), (s), (n)->real_num_tx_queues)
#ifndef CONFIG_PCI_IOV
#undef pci_enable_sriov
#define pci_enable_sriov(a, b) ((void)(a), (void)(b), -EOPNOTSUPP)
#undef pci_disable_sriov
#define pci_disable_sriov(a) ((void)(a))
...
#define pm_runtime_get_sync(dev)	((void)(dev), _kc_pm_runtime_get_sync())
#else /* 2.6.0 => 2.6.32 */
...
#define pm_runtime_put(dev)		((void)(dev))
#endif
#ifndef pm_runtime_put_sync
#define pm_runtime_put_sync(dev)	((void)(dev))
#endif
#ifndef pm_runtime_resume
#define pm_runtime_resume(dev)		((void)(dev))
#endif
#ifndef pm_schedule_suspend
#define pm_schedule_suspend(dev, t)	((void)(dev), (void)(t))
#endif
#ifndef pm_runtime_set_suspended
#define pm_runtime_set_suspended(dev)	((void)(dev))
#endif
#ifndef pm_runtime_disable
#define pm_runtime_disable(dev)		((void)(dev))
#endif
#ifndef pm_runtime_put_noidle
#define pm_runtime_put_noidle(dev)	((void)(dev))
#endif
#ifndef pm_runtime_set_active
#define pm_runtime_set_active(dev)	((void)(dev))
#endif
#ifndef pm_runtime_enable
#define pm_runtime_enable(dev)	((void)(dev))
#endif
#ifndef pm_runtime_get_noresume
#define pm_runtime_get_noresume(dev)	((void)(dev))
#endif
#else /* < 2.6.32 */
#if (RHEL_RELEASE_CODE && \
...
#if (!(RHEL_RELEASE_CODE && \
		(RHEL_RELEASE_VERSION(6, 2) <= RHEL_RELEASE_CODE)))
#define sk_tx_queue_get(_sk) ((void)(_sk), -1)
#define sk_tx_queue_set(_sk, _tx_queue) do { (void)(_sk); (void)(_tx_queue); } while (0)
#endif /* !(RHEL >= 6.2) */
...
#define pci_dev_run_wake(pdev)	((void)(pdev), 0)
#endif
...
#define pm_runtime_suspended(dev)	((void)(dev), _kc_pm_runtime_suspended())
#else /* 2.6.0 => 2.6.34 */
...
#undef usleep_range
#define usleep_range(min, max)	((void)(max), msleep(DIV_ROUND_UP(min, 1000)))
#endif

#define u64_stats_update_begin(a) ((void)(a))
#define u64_stats_update_end(a) ((void)(a))
#define u64_stats_fetch_begin(a) ((void)(a))
#define u64_stats_fetch_retry_bh(a, b) ((void)(a), (void)(b), 0)
#define u64_stats_fetch_begin_bh(a) ((void)(a), 0)
...
#define netdev_set_tc_queue(dev, tc, cnt, off) ((void)(dev), (void)(tc); (void)(cnt); (void)(off))
...
#define netdev_set_prio_tc_map(dev, up, tc) do { (void)(dev); (void)(up); (void)(tc); } while (0)
...
#ifndef kfree_rcu
#define kfree_rcu(_ptr, _rcu_head) ((void)(_rcu_head), kfree(_ptr))
#endif /* kfree_rcu */
...
#define __netdev_alloc_skb_ip_align(d, l, _g) ((void)(_g), netdev_alloc_skb_ip_align(d, l))
#endif /* __netdev_alloc_skb_ip_align */
#define dcb_ieee_setapp(dev, app) dcb_setapp(dev, app)
#define dcb_ieee_delapp(dev, app) ((void)(dev), (void)(app), 0)
#define dcb_ieee_getapp_mask(dev, app) ((void)(dev), (1 << app->priority))
 ...
 */
static inline struct workqueue_struct *__printf(3, 4)
...
#ifndef CONFIG_BQL
#define netdev_tx_completed_queue(_q, _p, _b) ((void)(_q), (void)(_p), (void)(_b))
#define netdev_completed_queue(_n, _p, _b) ((void)(_q), (void)(_p), (void)(_b))
#define netdev_tx_sent_queue(_q, _b) ((void)(_q), (void)(_b))
#define netdev_sent_queue(_n, _b) ((void)(_n), (void)(_b))
#define netdev_tx_reset_queue(_q) ((void)(_q))
#define netdev_reset_queue(_n) ((void)(_n))
#endif
...
#define napi_gro_flush(_napi, _flush_old) ((void)(_flush_old), napi_gro_flush(_napi))
#endif /* !RHEL6.8+ */
...
#define __setup_timer(_timer, _fn, _data, _flags)	\
	((void)(_flags), setup_timer((_timer), (_fn), (_data)))
...
static inline int __kc_pci_sriov_set_totalvfs(struct pci_dev __always_unused *dev,
...
#undef BUILD_BUG_ON
#ifdef __CHECKER__
#define BUILD_BUG_ON(condition) ((void)(condition), 0)
#else /* __CHECKER__ */
...
#define __compiletime_error_fallback(condition) ((void)(condition))
#else /* __GNUC__ */
#define __compiletime_error(message) ((void)(message))
...
#define hash_for_each(name, bkt, obj, member)				\
	for ((bkt) = 0, obj = NULL; !obj && (bkt) < HASH_SIZE(name);\
			(bkt)++)\
...
#else /* CONFIG_XPS */
#define netif_set_xps_queue(_dev, _mask, _idx) ((void)(_dev), (void)(_mask), (void)(_idx))
#endif /* CONFIG_XPS */
...
#define __vlan_hwaccel_put_tag(skb, vlan_proto, vlan_tci) \
	((void)(vlan_proto), __kc__vlan_hwaccel_put_tag(skb, vlan_tci))
#endif
...
#define u64_stats_init(a) ((void)(a))
#endif
#undef BIT_ULL
...
#endif
#define dev_alloc_pages(_order) alloc_pages_node(NUMA_NO_NODE, (GFP_ATOMIC | __GFP_COLD | \
	__GFP_COMP | __GFP_MEMALLOC), (_order))
#endif
...
#define __napi_alloc_skb(napi, len, mask) ((void)(mask), __kc_napi_alloc_skb(napi, len))
...
#endif
/*!RHEL7.2+ && !SLES11sp3(3.0.101-0.47.71+ update) && !SLES11sp4(3.0.101-65+ update) & !SLES12sp1+*/
#else
#undef HAVE_STRUCT_PAGE_PFMEMALLOC
#endif /* 4.1.9 */
...
#ifndef mmiowb
#ifdef CONFIG_IA64
#define mmiowb() do { asm volatile ("mf.a" ::: "memory"); } while (0)
#else
#define mmiowb()
#endif
#endif /* mmiowb */
