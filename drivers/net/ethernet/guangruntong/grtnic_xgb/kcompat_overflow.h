...
/**
 * prior to commit 54d50897d544 ("linux/kernel.h: split *_MAX and *_MIN
 * macros into <linux/limits.h>")
...
/**
 * Note: For compatibility, the definitions below directly wrap gcc's
 * type-generic overflow checkers (__builtin_*_overflow). Unlike the
 * upstream kernel implementation, these compatibility wrappers do not
 * enforce strict type matching between a, b, and *d.
 */
