...
/* 16-bit 转换函数实体化 */
____MAKE_OP(le16, u16, cpu_to_le16, le16_to_cpu)
____MAKE_OP(be16, u16, cpu_to_be16, be16_to_cpu)
____MAKE_OP(u16,  u16, ,)

/* 32-bit 转换函数实体化 */
____MAKE_OP(le32, u32, cpu_to_le32, le32_to_cpu)
____MAKE_OP(be32, u32, cpu_to_be32, be32_to_cpu)
____MAKE_OP(u32,  u32, ,)

/* 64-bit 转换函数实体化 */
____MAKE_OP(le64, u64, cpu_to_le64, le64_to_cpu)
____MAKE_OP(be64, u64, cpu_to_be64, be64_to_cpu)
____MAKE_OP(u64,  u64, ,)
...
#define devm_kfree(dev, p) ((void)(dev), kfree(p))
#else
...
#define devm_kzalloc(dev, size, flags) ((void)(dev), kzalloc(size, flags))
...
{
	struct msi_map map = { .index = -EOPNOTSUPP  };
	return map;
}
...
#define __has_builtin(x) ((void)(x), 0)
#endif
...
#else
#define _kc__assign_str(dst, src) ((void)(src), __assign_str(dst))
#endif
