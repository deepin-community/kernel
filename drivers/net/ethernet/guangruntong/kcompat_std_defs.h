...
#if (LINUX_VERSION_CODE < KERNEL_VERSION(2,6,24)) //sam
#else /* >= 3,10,0 */
...
/*****************************************************************************/
#if (LINUX_VERSION_CODE < KERNEL_VERSION(3,17,0) && LINUX_VERSION_CODE >= KERNEL_VERSION(3,13,0)) //sam
#define NEED_DEVM_KASPRINTF
#else /* >= 3,17,0 */
#endif /* 3,17,0 */

/*****************************************************************************/
#if (LINUX_VERSION_CODE < KERNEL_VERSION(3,18,0) && LINUX_VERSION_CODE >= KERNEL_VERSION(3,8,0)) //sam
