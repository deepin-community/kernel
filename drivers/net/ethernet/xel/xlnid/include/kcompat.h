...
#define PCI_VENDOR_ID_XEL 0xffe1
...
#define adapter_struct xlnid_adapter
#define adapter_q_vector xlnid_q_vector
...
#define CONFIG_XLNID_DISABLE_PACKET_SPLIT
#endif
...
/*****************************************************************************/
#ifndef SUPPORTED_1000baseX_Full
#define SUPPORTED_1000baseX_Full    BIT(41)
#endif

#ifndef SUPPORTED_MII
...
/*
		...
		Node module parameter of xlnid.
*/
...
static inline irqreturn_t _kc_request_irq(unsigned int irq,
		new_handler_t handler, unsigned long flags, const char *devname, void *dev_id)
#else /* 2.4.x */
...
static inline void __kc_mq_netif_napi_add(struct net_device *dev,
...
#undef xlnid_get_netdev_tc_txq
#define xlnid_get_netdev_tc_txq(dev, tc) (&netdev_extended(dev)->qos_data.tc_to_txq[tc])
#endif
/*****************************************************************************/
