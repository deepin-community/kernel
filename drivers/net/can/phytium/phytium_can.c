...
/* can_change_mtu() was removed in 7.2; keep the previous semantics locally. */
static int phytium_can_change_mtu(struct net_device *dev, int new_mtu)
{
...
static const struct net_device_ops phytium_can_netdev_ops = {
	...
	.ndo_change_mtu = phytium_can_change_mtu,
};
