...
#define _REGISTER_BLOCKID_H
    ...
    #define    BLOCK_CSP_GLOBAL_TIMESTAMP "8/27/2018 4:50:23 PM"
    #define    CSP_GLOBAL_BLOCK                                           0x0
    #define    CSP_GLOBAL_REG_START                                       0x0
    #define    CSP_GLOBAL_REG_END                                         0x3C0
    #define    CSP_GLOBAL_REG_LIMIT                                       0x3C0
#endif
    ...
    #define    GPCPFE_REG_END                                             0x28
    #define    GPCPFE_REG_LIMIT                                           0x28
#endif
    ...
    #define    BLOCK_TASFE_TIMESTAMP "10/13/2017 10:19:20 AM"
...
#define    TASBE_REG_LIMIT                                            0x8
    ...
    #define    BLOCK_FF_TIMESTAMP "2018/9/12 14:42:10"
    #define    FF_BLOCK                                                   0x6
    ...
    #define    BLOCK_IU_TIMESTAMP "2018/6/13 9:55:34"
    #define    IU_BLOCK                                                   0x7
...
#define    WLS_FE_REG_LIMIT                                           0x418
    ...
    #define    TUFE_REG_END                                               0x580
    #define    TUFE_REG_LIMIT                                             0x580
#endif
...
#define    MMU_REG_LIMIT                                              0x1000
    ...
    #define    TUBE_REG_END                                               0x580
    #define    TUBE_REG_LIMIT                                             0x580
#endif
