...
unsigned long ddk768_formatPllReg(pll_value_t *pPLL)
{
    ...
    */
    ulPllReg =
        SMI_FIELD_SET(0, VCLK_PLL, FN, FRAC_MODE)
      | SMI_FIELD_VALUE(0, VCLK_PLL, BS, pPLL->BS)      
      | SMI_FIELD_VALUE(0, VCLK_PLL, VCO, pPLL->VCO)
      | SMI_FIELD_VALUE(0, VCLK_PLL, INT, pPLL->INT)
      | SMI_FIELD_VALUE(0, VCLK_PLL, FRAC, pPLL->FRAC);
