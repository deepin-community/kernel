...
//  When written, the internal state machines will begin
//  transmitting the request to the sink device.
//  The AUX_ADDRESS and, when applicable, the AUX_WRITE_FIFO must
//  be set up before writing this register.
//
//  13 - AUX_PHY_WAKE:
//      Set to a 1 to send the AUX_PHY_WAKE signal for embedded DisplayPort operations.
//      This signal is sent as a standalone operation and is
//      not sent as a part of a larger AUX transaction.
//
//  12 - ADDRESS_ONLY:
