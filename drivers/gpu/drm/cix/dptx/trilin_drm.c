...
void trilin_dp_connector_reset(struct drm_connector *connector)
{
	...
	DP_DEBUG("enter. Note: This is empty function.\n");
}
...
static u8 trilin_dp_cal_bpc(struct trilin_dp *dp,
		struct drm_connector_state *connector_state, u8 bpc)
{
...
static void trilin_dp_rcsu_cfg_adapter(struct trilin_dp *dp,
		struct drm_connector_state *connector_state)
{
				     ...
				     struct drm_connector *connector)
{
	...
	//Fixme: max 10 for dpu, but not dp.
