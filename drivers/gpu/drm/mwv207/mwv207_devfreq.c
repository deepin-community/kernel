 ...
 *
 * The software and information contained herein is proprietary and * confidential
 * to JingJiaMicro Electronics. This software can only be used by JingJiaMicro
 * Electronics Corporation. Any use, reproduction, or disclosure without the written
 * permission of JingJiaMicro Electronics Corporation is strictly prohibited.
 */
