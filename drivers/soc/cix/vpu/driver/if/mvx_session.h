...
int mvx_session_construct(struct mvx_session *session,
			  ...
			  void (*event)(struct mvx_session *session,
				       ...
				       void *arg),
			  struct dentry *dsession, bool is_encoder);
 ...
 */
static inline struct mvx_session *mvx_if_session_to_session(struct
							    mvx_if_session
							    *session)
{
...
int mvx_session_set_color_conversion_ceof(struct mvx_session *session, struct mvx_color_conv_coef
					  *conv_coef);
