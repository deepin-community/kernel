...
struct mvx_buffer_param_region {
	uint16_t mbx_left;
			 /**< X coordinate of the left most macroblock */
	uint16_t mbx_right;
			 /**< X coordinate of the right most macroblock */
	uint16_t mby_top;/**< Y coordinate of the top most macroblock */
	uint16_t mby_bottom;
			 /**< Y coordinate of the bottom most macroblock */
	int16_t qp_delta;
...
#define MVX_MAX_FRAME_OSD_REGION 2
	struct mvx_param_osd_cfg osd_single_cfg[MVX_MAX_FRAME_OSD_REGION];
	/* include single osd region config and index */
};
