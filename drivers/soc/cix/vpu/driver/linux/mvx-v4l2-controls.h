...
struct v4l2_buffer_param_region {
	unsigned short mbx_left;
			       /*
				* < X coordinate of the left most macroblock
				*/
	unsigned short mbx_right;
			       /*
				* < X coordinate of the right most macroblock
				*/
	unsigned short mby_top;	/*
				 * < Y coordinate of the top most macroblock
				 */
	unsigned short mby_bottom;
			       /*
...
struct v4l2_osd_config {
	...
	struct v4l2_mvx_osd_cfg osd_single_cfg[V4L2_MAX_FRAME_OSD_REGION];
