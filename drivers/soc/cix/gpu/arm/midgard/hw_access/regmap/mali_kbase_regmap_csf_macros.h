...
/**
 * Used to access the GPU reserved register with offset address 0x3000-0x3FFC
 * TODO: Needs to confirm with Arm why it is necessary to set reserved
 * registers to make LS_MEM_* related counters work.
 */
#define GPU_RESERVED_ENUM(regname) GPU_RESERVED__##regname
