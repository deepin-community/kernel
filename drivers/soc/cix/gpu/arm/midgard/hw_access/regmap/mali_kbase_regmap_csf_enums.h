...
enum kbase_regmap_enum_v12 {
	...
	GPU_RESERVED__CONFIG_INIT, /* (RW) 32-bit 0x3068 */
	GPU_RESERVED__CSHW, /* (RW) 32-bit 0x306C */
	GPU_RESERVED__SHADER, /* (RW) 32-bit 0x3070 */
	GPU_RESERVED__TILE, /* (RW) 32-bit 0x3074 */
	GPU_RESERVED__MEMSYS, /* (RW) 32-bit 0x307C */
	NR_V12_REGS,
};
...
enum kbase_regmap_enum_v14_8 {
	GPU_CONTROL__HOST_POWER__BASE_PRESENT = NR_V12_REGS, /* (RO) 64-bit 0xB80 */
	GPU_CONTROL__HOST_POWER__BASE_PWRACTIVE, /* (RO) 64-bit 0xB98 */
	GPU_CONTROL__HOST_POWER__BASE_PWRTRANS, /* (RO) 64-bit 0xB90 */
	GPU_CONTROL__HOST_POWER__BASE_READY, /* (RO) 64-bit 0xB88 */
	GPU_CONTROL__HOST_POWER__NEURAL_PRESENT, /* (RO) 64-bit 0xA40 */
	GPU_CONTROL__HOST_POWER__NEURAL_PWRACTIVE, /* (RO) 64-bit 0xA58 */
	GPU_CONTROL__HOST_POWER__NEURAL_PWRTRANS, /* (RO) 64-bit 0xA50 */
	GPU_CONTROL__HOST_POWER__NEURAL_READY, /* (RO) 64-bit 0xA48 */
	GPU_CONTROL__HOST_POWER__PWR_CMDARG, /* (RW) 64-bit 0x830 */
	GPU_CONTROL__HOST_POWER__PWR_COMMAND, /* (WO) 32-bit 0x828 */
	GPU_CONTROL__HOST_POWER__PWR_IRQ_CLEAR, /* (WO) 32-bit 0x804 */
	GPU_CONTROL__HOST_POWER__PWR_IRQ_MASK, /* (RW) 32-bit 0x808 */
	GPU_CONTROL__HOST_POWER__PWR_IRQ_RAWSTAT, /* (RW) 32-bit 0x800 */
	GPU_CONTROL__HOST_POWER__PWR_IRQ_STATUS, /* (RO) 32-bit 0x80C */
	GPU_CONTROL__HOST_POWER__PWR_STATUS, /* (RO) 64-bit 0x820 */
	GPU_CONTROL__NEURAL_CONFIG, /* (RW) 32-bit 0xF10 */
	GPU_CONTROL__NEURAL_CONTROL, /* (RW) 32-bit 0xEFC */
	GPU_GOVERNOR__GOV_CORE_MASK, /* (RW) 64-bit 0x40120 */
	GPU_GOVERNOR__GOV_FEATURES, /* (RO) 64-bit 0x40100 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_NEURAL, /* (RW) 64-bit 0x41030 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_0, /* (RO) 64-bit 0x41200 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_1, /* (RO) 64-bit 0x41208 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_2, /* (RO) 64-bit 0x41210 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_3, /* (RO) 64-bit 0x41218 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_4, /* (RO) 64-bit 0x41220 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_5, /* (RO) 64-bit 0x41228 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_6, /* (RO) 64-bit 0x41230 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_7, /* (RO) 64-bit 0x41238 */
	NR_V14_8_REGS,
};

enum kbase_regmap_enum_v14_8_remap {
	GPU_CONTROL__L2C_SLICE_HASH_0 = GPU_CONTROL__ASN_HASH_0, /* (RW) 32-bit 0x2C0 */
	GPU_CONTROL__L2C_SLICE_HASH_1 = GPU_CONTROL__ASN_HASH_1, /* (RW) 32-bit 0x2C4 */
	GPU_CONTROL__L2C_SLICE_HASH_2 = GPU_CONTROL__ASN_HASH_2, /* (RW) 32-bit 0x2C8 */
	GPU_CONTROL__HOST_POWER__L2_PRESENT =
		GPU_CONTROL__L2_PRESENT, /* (RO) 64-bit 0x120 -> (RO) 64-bit 0x900 */
	GPU_CONTROL__HOST_POWER__L2_PWRACTIVE =
		GPU_CONTROL__L2_PWRACTIVE, /* (RO) 64-bit 0x260 -> (RO) 64-bit 0x918 */
	GPU_CONTROL__HOST_POWER__L2_PWRTRANS =
		GPU_CONTROL__L2_PWRTRANS, /* (RO) 64-bit 0x220 -> (RO) 64-bit 0x910 */
	GPU_CONTROL__HOST_POWER__L2_READY =
		GPU_CONTROL__L2_READY, /* (RO) 64-bit 0x160 -> (RO) 64-bit 0x908 */
	GPU_CONTROL__HOST_POWER__SHADER_PRESENT =
		GPU_CONTROL__SHADER_PRESENT, /* (RO) 64-bit 0x100 -> (RO) 64-bit 0xA00 */
	GPU_CONTROL__HOST_POWER__SHADER_PWRACTIVE =
		GPU_CONTROL__SHADER_PWRACTIVE, /* (RO) 64-bit 0x240 -> (RO) 64-bit 0xA18 */
	GPU_CONTROL__HOST_POWER__SHADER_PWRTRANS =
		GPU_CONTROL__SHADER_PWRTRANS, /* (RO) 64-bit 0x200 -> (RO) 64-bit 0xA10 */
	GPU_CONTROL__HOST_POWER__SHADER_READY =
		GPU_CONTROL__SHADER_READY, /* (RO) 64-bit 0x140 -> (RO) 64-bit 0xA08 */
	GPU_CONTROL__HOST_POWER__STACK_PRESENT =
		GPU_CONTROL__STACK_PRESENT, /* (RO) 64-bit 0xE00 -> (RO) 64-bit 0xBC0 */
	GPU_CONTROL__HOST_POWER__STACK_PWRTRANS =
		GPU_CONTROL__STACK_PWRTRANS, /* (RO) 64-bit 0xE40 -> (RO) 64-bit 0xBD0 */
	GPU_CONTROL__HOST_POWER__STACK_READY =
		GPU_CONTROL__STACK_READY, /* (RO) 64-bit 0xE10 -> (RO) 64-bit 0xBC8 */
	GPU_CONTROL__HOST_POWER__TILER_PRESENT =
		GPU_CONTROL__TILER_PRESENT, /* (RO) 64-bit 0x110 -> (RO) 64-bit 0x940 */
	GPU_CONTROL__HOST_POWER__TILER_PWRACTIVE =
		GPU_CONTROL__TILER_PWRACTIVE, /* (RO) 64-bit 0x250 -> (RO) 64-bit 0x958 */
	GPU_CONTROL__HOST_POWER__TILER_PWRTRANS =
		GPU_CONTROL__TILER_PWRTRANS, /* (RO) 64-bit 0x210 -> (RO) 64-bit 0x950 */
	GPU_CONTROL__HOST_POWER__TILER_READY =
		GPU_CONTROL__TILER_READY, /* (RO) 64-bit 0x150 -> (RO) 64-bit 0x948 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__COMMAND =
		IPA_CONTROL__COMMAND, /* (WO) 32-bit 0x40000 -> (WO) 32-bit 0x41000 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_CSHW =
		IPA_CONTROL__SELECT_CSHW, /* (RW) 64-bit 0x40010 -> (RW) 64-bit 0x41010 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_MEMSYS =
		IPA_CONTROL__SELECT_MEMSYS, /* (RW) 64-bit 0x40018 -> (RW) 64-bit 0x41018 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_SHADER =
		IPA_CONTROL__SELECT_SHADER, /* (RW) 64-bit 0x40028 -> (RW) 64-bit 0x41028 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_TILER =
		IPA_CONTROL__SELECT_TILER, /* (RW) 64-bit 0x40020 -> (RW) 64-bit 0x41020 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__STATUS =
		IPA_CONTROL__STATUS, /* (RO) 32-bit 0x40004 -> (RO) 32-bit 0x41004 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__TIMER =
		IPA_CONTROL__TIMER, /* (RW) 32-bit 0x40008 -> (RW) 32-bit 0x41008 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_0 =
		IPA_CONTROL__VALUE_CSHW_0, /* (RO) 64-bit 0x40100 -> (RO) 64-bit 0x41100 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_1 =
		IPA_CONTROL__VALUE_CSHW_1, /* (RO) 64-bit 0x40108 -> (RO) 64-bit 0x41108 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_2 =
		IPA_CONTROL__VALUE_CSHW_2, /* (RO) 64-bit 0x40110 -> (RO) 64-bit 0x41110 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_3 =
		IPA_CONTROL__VALUE_CSHW_3, /* (RO) 64-bit 0x40118 -> (RO) 64-bit 0x41118 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_4 =
		IPA_CONTROL__VALUE_CSHW_4, /* (RO) 64-bit 0x40120 -> (RO) 64-bit 0x41120 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_5 =
		IPA_CONTROL__VALUE_CSHW_5, /* (RO) 64-bit 0x40128 -> (RO) 64-bit 0x41128 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_6 =
		IPA_CONTROL__VALUE_CSHW_6, /* (RO) 64-bit 0x40130 -> (RO) 64-bit 0x41130 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_7 =
		IPA_CONTROL__VALUE_CSHW_7, /* (RO) 64-bit 0x40138 -> (RO) 64-bit 0x41138 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_0 =
		IPA_CONTROL__VALUE_MEMSYS_0, /* (RO) 64-bit 0x40140 -> (RO) 64-bit 0x41140 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_1 =
		IPA_CONTROL__VALUE_MEMSYS_1, /* (RO) 64-bit 0x40148 -> (RO) 64-bit 0x41148 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_2 =
		IPA_CONTROL__VALUE_MEMSYS_2, /* (RO) 64-bit 0x40150 -> (RO) 64-bit 0x41150 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_3 =
		IPA_CONTROL__VALUE_MEMSYS_3, /* (RO) 64-bit 0x40158 -> (RO) 64-bit 0x41158 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_4 =
		IPA_CONTROL__VALUE_MEMSYS_4, /* (RO) 64-bit 0x40160 -> (RO) 64-bit 0x41160 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_5 =
		IPA_CONTROL__VALUE_MEMSYS_5, /* (RO) 64-bit 0x40168 -> (RO) 64-bit 0x41168 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_6 =
		IPA_CONTROL__VALUE_MEMSYS_6, /* (RO) 64-bit 0x40170 -> (RO) 64-bit 0x41170 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_7 =
		IPA_CONTROL__VALUE_MEMSYS_7, /* (RO) 64-bit 0x40178 -> (RO) 64-bit 0x41178 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_0 =
		IPA_CONTROL__VALUE_SHADER_0, /* (RO) 64-bit 0x401C0 -> (RO) 64-bit 0x411C0 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_1 =
		IPA_CONTROL__VALUE_SHADER_1, /* (RO) 64-bit 0x401C8 -> (RO) 64-bit 0x411C8 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_2 =
		IPA_CONTROL__VALUE_SHADER_2, /* (RO) 64-bit 0x401D0 -> (RO) 64-bit 0x411D0 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_3 =
		IPA_CONTROL__VALUE_SHADER_3, /* (RO) 64-bit 0x401D8 -> (RO) 64-bit 0x411D8 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_4 =
		IPA_CONTROL__VALUE_SHADER_4, /* (RO) 64-bit 0x401E0 -> (RO) 64-bit 0x411E0 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_5 =
		IPA_CONTROL__VALUE_SHADER_5, /* (RO) 64-bit 0x401E8 -> (RO) 64-bit 0x411E8 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_6 =
		IPA_CONTROL__VALUE_SHADER_6, /* (RO) 64-bit 0x401F0 -> (RO) 64-bit 0x411F0 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_7 =
		IPA_CONTROL__VALUE_SHADER_7, /* (RO) 64-bit 0x401F8 -> (RO) 64-bit 0x411F8 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_0 =
		IPA_CONTROL__VALUE_TILER_0, /* (RO) 64-bit 0x40180 -> (RO) 64-bit 0x41180 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_1 =
		IPA_CONTROL__VALUE_TILER_1, /* (RO) 64-bit 0x40188 -> (RO) 64-bit 0x41188 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_2 =
		IPA_CONTROL__VALUE_TILER_2, /* (RO) 64-bit 0x40190 -> (RO) 64-bit 0x41190 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_3 =
		IPA_CONTROL__VALUE_TILER_3, /* (RO) 64-bit 0x40198 -> (RO) 64-bit 0x41198 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_4 =
		IPA_CONTROL__VALUE_TILER_4, /* (RO) 64-bit 0x401A0 -> (RO) 64-bit 0x411A0 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_5 =
		IPA_CONTROL__VALUE_TILER_5, /* (RO) 64-bit 0x401A8 -> (RO) 64-bit 0x411A8 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_6 =
		IPA_CONTROL__VALUE_TILER_6, /* (RO) 64-bit 0x401B0 -> (RO) 64-bit 0x411B0 */
	GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_7 =
		IPA_CONTROL__VALUE_TILER_7, /* (RO) 64-bit 0x401B8 -> (RO) 64-bit 0x411B8 */
};

/*
 * V14_8_REMOVED_REGS:
 * GPU_CONTROL__CSF_ID
 * GPU_CONTROL__GPU_DBG
 * GPU_CONTROL__L2_PWROFF
 * GPU_CONTROL__L2_PWRON
 * GPU_CONTROL__SHADER_PWRFEATURES
 * GPU_CONTROL__SHADER_PWROFF
 * GPU_CONTROL__SHADER_PWRON
 * GPU_CONTROL__STACK_PWROFF
 * GPU_CONTROL__STACK_PWRON
 * GPU_CONTROL__TILER_PWROFF
 * GPU_CONTROL__TILER_PWRON
 * MMU_CONTROL__AS0__FAULTEXTRA
 * MMU_CONTROL__AS10__FAULTEXTRA
 * MMU_CONTROL__AS11__FAULTEXTRA
 * MMU_CONTROL__AS12__FAULTEXTRA
 * MMU_CONTROL__AS13__FAULTEXTRA
 * MMU_CONTROL__AS14__FAULTEXTRA
 * MMU_CONTROL__AS15__FAULTEXTRA
 * MMU_CONTROL__AS1__FAULTEXTRA
 * MMU_CONTROL__AS2__FAULTEXTRA
 * MMU_CONTROL__AS3__FAULTEXTRA
 * MMU_CONTROL__AS4__FAULTEXTRA
 * MMU_CONTROL__AS5__FAULTEXTRA
 * MMU_CONTROL__AS6__FAULTEXTRA
 * MMU_CONTROL__AS7__FAULTEXTRA
 * MMU_CONTROL__AS8__FAULTEXTRA
 * MMU_CONTROL__AS9__FAULTEXTRA
 */
