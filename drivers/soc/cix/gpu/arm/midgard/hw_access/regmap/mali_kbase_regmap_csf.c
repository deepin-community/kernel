...
static void kbase_regmap_v12_init(struct kbase_device *kbdev)
{
	...
	kbdev->regmap.flags[GPU_CONTROL__AMBA_FEATURES] = KBASE_REGMAP_WIDTH_32_BIT |
							  KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_RESERVED__CONFIG_INIT] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_RESERVED__CSHW] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_RESERVED__MEMSYS] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_RESERVED__SHADER] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_RESERVED__TILE] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	...
	kbdev->regmap.regs[GPU_RESERVED__CONFIG_INIT] = kbdev->reg + 0x3068;
	kbdev->regmap.regs[GPU_RESERVED__CSHW] = kbdev->reg + 0x306C;
	kbdev->regmap.regs[GPU_RESERVED__MEMSYS] = kbdev->reg + 0x3070;
	kbdev->regmap.regs[GPU_RESERVED__SHADER] = kbdev->reg + 0x3074;
	kbdev->regmap.regs[GPU_RESERVED__TILE] = kbdev->reg + 0x307C;
	kbdev->regmap.regs[GPU_CONTROL__COHERENCY_ENABLE] = NULL;
}

static void kbase_regmap_v14_8_init(struct kbase_device *kbdev)
{
	if (kbdev->regmap.regs == NULL && kbdev->regmap.flags == NULL) {
		kbdev->regmap.size = NR_V14_8_REGS;
		kbdev->regmap.regs =
			kcalloc(kbdev->regmap.size, sizeof(void __iomem *), GFP_KERNEL);
		kbdev->regmap.flags = kcalloc(kbdev->regmap.size, sizeof(u32), GFP_KERNEL);
	}
	...
	kbase_regmap_v12_init(kbdev);

	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__BASE_PRESENT] = KBASE_REGMAP_WIDTH_64_BIT |
								     KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__BASE_PWRACTIVE] = KBASE_REGMAP_WIDTH_64_BIT |
								       KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__BASE_PWRTRANS] = KBASE_REGMAP_WIDTH_64_BIT |
								      KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__BASE_READY] = KBASE_REGMAP_WIDTH_64_BIT |
								   KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__NEURAL_PRESENT] = KBASE_REGMAP_WIDTH_64_BIT |
								       KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__NEURAL_PWRACTIVE] = KBASE_REGMAP_WIDTH_64_BIT |
									 KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__NEURAL_PWRTRANS] = KBASE_REGMAP_WIDTH_64_BIT |
									KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__NEURAL_READY] = KBASE_REGMAP_WIDTH_64_BIT |
								     KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__PWR_CMDARG] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__PWR_COMMAND] = KBASE_REGMAP_WIDTH_32_BIT |
								    KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__PWR_IRQ_CLEAR] = KBASE_REGMAP_WIDTH_32_BIT |
								      KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__PWR_IRQ_MASK] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__PWR_IRQ_RAWSTAT] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__PWR_IRQ_STATUS] = KBASE_REGMAP_WIDTH_32_BIT |
								       KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__PWR_STATUS] = KBASE_REGMAP_WIDTH_64_BIT |
								   KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__NEURAL_CONFIG] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_CONTROL__NEURAL_CONTROL] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_CORE_MASK] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_FEATURES] = KBASE_REGMAP_WIDTH_64_BIT |
							  KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_NEURAL] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_0] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_1] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_2] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_3] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_4] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_5] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_6] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_7] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__L2C_SLICE_HASH_0] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_CONTROL__L2C_SLICE_HASH_1] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_CONTROL__L2C_SLICE_HASH_2] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__L2_PRESENT] = KBASE_REGMAP_WIDTH_64_BIT |
								   KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__L2_PWRACTIVE] = KBASE_REGMAP_WIDTH_64_BIT |
								     KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__L2_PWRTRANS] = KBASE_REGMAP_WIDTH_64_BIT |
								    KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__L2_READY] = KBASE_REGMAP_WIDTH_64_BIT |
								 KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__SHADER_PRESENT] = KBASE_REGMAP_WIDTH_64_BIT |
								       KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__SHADER_PWRACTIVE] = KBASE_REGMAP_WIDTH_64_BIT |
									 KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__SHADER_PWRTRANS] = KBASE_REGMAP_WIDTH_64_BIT |
									KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__SHADER_READY] = KBASE_REGMAP_WIDTH_64_BIT |
								     KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__STACK_PRESENT] = KBASE_REGMAP_WIDTH_64_BIT |
								      KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__STACK_PWRTRANS] = KBASE_REGMAP_WIDTH_64_BIT |
								       KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__STACK_READY] = KBASE_REGMAP_WIDTH_64_BIT |
								    KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__TILER_PRESENT] = KBASE_REGMAP_WIDTH_64_BIT |
								      KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__TILER_PWRACTIVE] = KBASE_REGMAP_WIDTH_64_BIT |
									KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__TILER_PWRTRANS] = KBASE_REGMAP_WIDTH_64_BIT |
								       KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__HOST_POWER__TILER_READY] = KBASE_REGMAP_WIDTH_64_BIT |
								    KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__COMMAND] = KBASE_REGMAP_WIDTH_32_BIT |
								      KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_CSHW] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_MEMSYS] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_SHADER] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_TILER] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__STATUS] = KBASE_REGMAP_WIDTH_32_BIT |
								     KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__TIMER] =
		KBASE_REGMAP_WIDTH_32_BIT | KBASE_REGMAP_PERM_READ | KBASE_REGMAP_PERM_WRITE;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_0] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_1] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_2] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_3] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_4] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_5] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_6] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_7] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_0] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_1] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_2] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_3] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_4] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_5] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_6] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_7] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_0] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_1] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_2] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_3] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_4] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_5] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_6] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_7] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_0] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_1] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_2] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_3] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_4] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_5] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_6] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_7] =
		KBASE_REGMAP_WIDTH_64_BIT | KBASE_REGMAP_PERM_READ;
	kbdev->regmap.flags[GPU_CONTROL__CSF_ID] = 0;
	kbdev->regmap.flags[GPU_CONTROL__GPU_DBG] = 0;
	kbdev->regmap.flags[GPU_CONTROL__L2_PWROFF] = 0;
	kbdev->regmap.flags[GPU_CONTROL__L2_PWRON] = 0;
	kbdev->regmap.flags[GPU_CONTROL__SHADER_PWRFEATURES] = 0;
	kbdev->regmap.flags[GPU_CONTROL__SHADER_PWROFF] = 0;
	kbdev->regmap.flags[GPU_CONTROL__SHADER_PWRON] = 0;
	kbdev->regmap.flags[GPU_CONTROL__STACK_PWROFF] = 0;
	kbdev->regmap.flags[GPU_CONTROL__STACK_PWRON] = 0;
	kbdev->regmap.flags[GPU_CONTROL__TILER_PWROFF] = 0;
	kbdev->regmap.flags[GPU_CONTROL__TILER_PWRON] = 0;
	kbdev->regmap.flags[MMU_CONTROL__AS0__FAULTEXTRA] = 0;
	kbdev->regmap.flags[MMU_CONTROL__AS10__FAULTEXTRA] = 0;
	kbdev->regmap.flags[MMU_CONTROL__AS11__FAULTEXTRA] = 0;
	kbdev->regmap.flags[MMU_CONTROL__AS12__FAULTEXTRA] = 0;
	kbdev->regmap.flags[MMU_CONTROL__AS13__FAULTEXTRA] = 0;
	kbdev->regmap.flags[MMU_CONTROL__AS14__FAULTEXTRA] = 0;
	kbdev->regmap.flags[MMU_CONTROL__AS15__FAULTEXTRA] = 0;
	kbdev->regmap.flags[MMU_CONTROL__AS1__FAULTEXTRA] = 0;
	kbdev->regmap.flags[MMU_CONTROL__AS2__FAULTEXTRA] = 0;
	kbdev->regmap.flags[MMU_CONTROL__AS3__FAULTEXTRA] = 0;
	kbdev->regmap.flags[MMU_CONTROL__AS4__FAULTEXTRA] = 0;
	kbdev->regmap.flags[MMU_CONTROL__AS5__FAULTEXTRA] = 0;
	kbdev->regmap.flags[MMU_CONTROL__AS6__FAULTEXTRA] = 0;
	kbdev->regmap.flags[MMU_CONTROL__AS7__FAULTEXTRA] = 0;
	kbdev->regmap.flags[MMU_CONTROL__AS8__FAULTEXTRA] = 0;
	kbdev->regmap.flags[MMU_CONTROL__AS9__FAULTEXTRA] = 0;

	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__BASE_PRESENT] = kbdev->reg + 0xb80;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__BASE_PWRACTIVE] = kbdev->reg + 0xb98;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__BASE_PWRTRANS] = kbdev->reg + 0xb90;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__BASE_READY] = kbdev->reg + 0xb88;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__NEURAL_PRESENT] = kbdev->reg + 0xa40;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__NEURAL_PWRACTIVE] = kbdev->reg + 0xa58;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__NEURAL_PWRTRANS] = kbdev->reg + 0xa50;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__NEURAL_READY] = kbdev->reg + 0xa48;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__PWR_CMDARG] = kbdev->reg + 0x830;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__PWR_COMMAND] = kbdev->reg + 0x828;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__PWR_IRQ_CLEAR] = kbdev->reg + 0x804;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__PWR_IRQ_MASK] = kbdev->reg + 0x808;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__PWR_IRQ_RAWSTAT] = kbdev->reg + 0x800;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__PWR_IRQ_STATUS] = kbdev->reg + 0x80c;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__PWR_STATUS] = kbdev->reg + 0x820;
	kbdev->regmap.regs[GPU_CONTROL__NEURAL_CONFIG] = kbdev->reg + 0xf10;
	kbdev->regmap.regs[GPU_CONTROL__NEURAL_CONTROL] = kbdev->reg + 0xefc;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_CORE_MASK] = kbdev->reg + 0x40120;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_FEATURES] = kbdev->reg + 0x40100;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_NEURAL] = kbdev->reg + 0x41030;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_0] = kbdev->reg + 0x41200;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_1] = kbdev->reg + 0x41208;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_2] = kbdev->reg + 0x41210;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_3] = kbdev->reg + 0x41218;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_4] = kbdev->reg + 0x41220;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_5] = kbdev->reg + 0x41228;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_6] = kbdev->reg + 0x41230;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_7] = kbdev->reg + 0x41238;
	kbdev->regmap.regs[GPU_CONTROL__L2C_SLICE_HASH_0] = kbdev->reg + 0x2c0;
	kbdev->regmap.regs[GPU_CONTROL__L2C_SLICE_HASH_1] = kbdev->reg + 0x2c4;
	kbdev->regmap.regs[GPU_CONTROL__L2C_SLICE_HASH_2] = kbdev->reg + 0x2c8;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__L2_PRESENT] = kbdev->reg + 0x900;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__L2_PWRACTIVE] = kbdev->reg + 0x918;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__L2_PWRTRANS] = kbdev->reg + 0x910;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__L2_READY] = kbdev->reg + 0x908;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__SHADER_PRESENT] = kbdev->reg + 0xa00;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__SHADER_PWRACTIVE] = kbdev->reg + 0xa18;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__SHADER_PWRTRANS] = kbdev->reg + 0xa10;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__SHADER_READY] = kbdev->reg + 0xa08;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__STACK_PRESENT] = kbdev->reg + 0xbc0;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__STACK_PWRTRANS] = kbdev->reg + 0xbd0;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__STACK_READY] = kbdev->reg + 0xbc8;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__TILER_PRESENT] = kbdev->reg + 0x940;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__TILER_PWRACTIVE] = kbdev->reg + 0x958;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__TILER_PWRTRANS] = kbdev->reg + 0x950;
	kbdev->regmap.regs[GPU_CONTROL__HOST_POWER__TILER_READY] = kbdev->reg + 0x948;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__COMMAND] = kbdev->reg + 0x41000;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_CSHW] = kbdev->reg + 0x41010;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_MEMSYS] = kbdev->reg + 0x41018;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_SHADER] = kbdev->reg + 0x41028;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_TILER] = kbdev->reg + 0x41020;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__STATUS] = kbdev->reg + 0x41004;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__TIMER] = kbdev->reg + 0x41008;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_0] = kbdev->reg + 0x41100;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_1] = kbdev->reg + 0x41108;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_2] = kbdev->reg + 0x41110;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_3] = kbdev->reg + 0x41118;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_4] = kbdev->reg + 0x41120;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_5] = kbdev->reg + 0x41128;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_6] = kbdev->reg + 0x41130;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_CSHW_7] = kbdev->reg + 0x41138;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_0] = kbdev->reg + 0x41140;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_1] = kbdev->reg + 0x41148;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_2] = kbdev->reg + 0x41150;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_3] = kbdev->reg + 0x41158;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_4] = kbdev->reg + 0x41160;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_5] = kbdev->reg + 0x41168;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_6] = kbdev->reg + 0x41170;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_MEMSYS_7] = kbdev->reg + 0x41178;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_0] = kbdev->reg + 0x411c0;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_1] = kbdev->reg + 0x411c8;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_2] = kbdev->reg + 0x411d0;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_3] = kbdev->reg + 0x411d8;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_4] = kbdev->reg + 0x411e0;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_5] = kbdev->reg + 0x411e8;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_6] = kbdev->reg + 0x411f0;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_SHADER_7] = kbdev->reg + 0x411f8;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_0] = kbdev->reg + 0x41180;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_1] = kbdev->reg + 0x41188;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_2] = kbdev->reg + 0x41190;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_3] = kbdev->reg + 0x41198;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_4] = kbdev->reg + 0x411a0;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_5] = kbdev->reg + 0x411a8;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_6] = kbdev->reg + 0x411b0;
	kbdev->regmap.regs[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_TILER_7] = kbdev->reg + 0x411b8;
	kbdev->regmap.regs[GPU_CONTROL__CSF_ID] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__GPU_DBG] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__L2_PWROFF] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__L2_PWRON] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__SHADER_PWRFEATURES] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__SHADER_PWROFF] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__SHADER_PWRON] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__STACK_PWROFF] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__STACK_PWRON] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__TILER_PWROFF] = NULL;
	kbdev->regmap.regs[GPU_CONTROL__TILER_PWRON] = NULL;
	kbdev->regmap.regs[MMU_CONTROL__AS0__FAULTEXTRA] = NULL;
	kbdev->regmap.regs[MMU_CONTROL__AS10__FAULTEXTRA] = NULL;
	kbdev->regmap.regs[MMU_CONTROL__AS11__FAULTEXTRA] = NULL;
	kbdev->regmap.regs[MMU_CONTROL__AS12__FAULTEXTRA] = NULL;
	kbdev->regmap.regs[MMU_CONTROL__AS13__FAULTEXTRA] = NULL;
	kbdev->regmap.regs[MMU_CONTROL__AS14__FAULTEXTRA] = NULL;
	kbdev->regmap.regs[MMU_CONTROL__AS15__FAULTEXTRA] = NULL;
	kbdev->regmap.regs[MMU_CONTROL__AS1__FAULTEXTRA] = NULL;
	kbdev->regmap.regs[MMU_CONTROL__AS2__FAULTEXTRA] = NULL;
	kbdev->regmap.regs[MMU_CONTROL__AS3__FAULTEXTRA] = NULL;
	kbdev->regmap.regs[MMU_CONTROL__AS4__FAULTEXTRA] = NULL;
	kbdev->regmap.regs[MMU_CONTROL__AS5__FAULTEXTRA] = NULL;
	kbdev->regmap.regs[MMU_CONTROL__AS6__FAULTEXTRA] = NULL;
	kbdev->regmap.regs[MMU_CONTROL__AS7__FAULTEXTRA] = NULL;
	kbdev->regmap.regs[MMU_CONTROL__AS8__FAULTEXTRA] = NULL;
	kbdev->regmap.regs[MMU_CONTROL__AS9__FAULTEXTRA] = NULL;
}
...
u32 kbase_regmap_backend_init(struct kbase_device *kbdev)
{
	...
	struct {
		...
		{ GPU_ID_ARCH_MAKE(14, 8, 0), kbase_regmap_v14_8_init },
	};
...
static char *enum_strings[] = {
	...
	[GPU_CONTROL__HOST_POWER__BASE_PRESENT] = "GPU_CONTROL__HOST_POWER__BASE_PRESENT",
	[GPU_CONTROL__HOST_POWER__BASE_PWRACTIVE] = "GPU_CONTROL__HOST_POWER__BASE_PWRACTIVE",
	[GPU_CONTROL__HOST_POWER__BASE_PWRTRANS] = "GPU_CONTROL__HOST_POWER__BASE_PWRTRANS",
	[GPU_CONTROL__HOST_POWER__BASE_READY] = "GPU_CONTROL__HOST_POWER__BASE_READY",
	[GPU_CONTROL__HOST_POWER__NEURAL_PRESENT] = "GPU_CONTROL__HOST_POWER__NEURAL_PRESENT",
	[GPU_CONTROL__HOST_POWER__NEURAL_PWRACTIVE] = "GPU_CONTROL__HOST_POWER__NEURAL_PWRACTIVE",
	[GPU_CONTROL__HOST_POWER__NEURAL_PWRTRANS] = "GPU_CONTROL__HOST_POWER__NEURAL_PWRTRANS",
	[GPU_CONTROL__HOST_POWER__NEURAL_READY] = "GPU_CONTROL__HOST_POWER__NEURAL_READY",
	[GPU_CONTROL__HOST_POWER__PWR_CMDARG] = "GPU_CONTROL__HOST_POWER__PWR_CMDARG",
	[GPU_CONTROL__HOST_POWER__PWR_COMMAND] = "GPU_CONTROL__HOST_POWER__PWR_COMMAND",
	[GPU_CONTROL__HOST_POWER__PWR_IRQ_CLEAR] = "GPU_CONTROL__HOST_POWER__PWR_IRQ_CLEAR",
	[GPU_CONTROL__HOST_POWER__PWR_IRQ_MASK] = "GPU_CONTROL__HOST_POWER__PWR_IRQ_MASK",
	[GPU_CONTROL__HOST_POWER__PWR_IRQ_RAWSTAT] = "GPU_CONTROL__HOST_POWER__PWR_IRQ_RAWSTAT",
	[GPU_CONTROL__HOST_POWER__PWR_IRQ_STATUS] = "GPU_CONTROL__HOST_POWER__PWR_IRQ_STATUS",
	[GPU_CONTROL__HOST_POWER__PWR_STATUS] = "GPU_CONTROL__HOST_POWER__PWR_STATUS",
	[GPU_CONTROL__NEURAL_CONFIG] = "GPU_CONTROL__NEURAL_CONFIG",
	[GPU_CONTROL__NEURAL_CONTROL] = "GPU_CONTROL__NEURAL_CONTROL",
	[GPU_GOVERNOR__GOV_CORE_MASK] = "GPU_GOVERNOR__GOV_CORE_MASK",
	[GPU_GOVERNOR__GOV_FEATURES] = "GPU_GOVERNOR__GOV_FEATURES",
	[GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_NEURAL] =
		"GPU_GOVERNOR__GOV_IPA_CONTROL__SELECT_NEURAL",
	[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_0] =
		"GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_0",
	[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_1] =
		"GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_1",
	[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_2] =
		"GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_2",
	[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_3] =
		"GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_3",
	[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_4] =
		"GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_4",
	[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_5] =
		"GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_5",
	[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_6] =
		"GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_6",
	[GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_7] =
		"GPU_GOVERNOR__GOV_IPA_CONTROL__VALUE_NEURAL_7",
};
