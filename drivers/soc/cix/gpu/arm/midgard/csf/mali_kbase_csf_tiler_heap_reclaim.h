...
/*
 * kbase_csf_tiler_heap_reclaim_mgr_init - Initializer for the tiler heap reclaim manager.
...
/*
 * kbase_csf_tiler_heap_reclaim_mgr_term - Termination call for the tiler heap reclaim manager.
 *
 * @kbdev: Pointer to the device.
 *
 */
