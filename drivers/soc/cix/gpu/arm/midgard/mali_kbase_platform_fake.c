 ...
 *
 * Function converts data in struct kbase_io_resources struct to an
 * array of Linux resource structures. Note that function
...
int kbase_platform_register(void)
{
	...
	config =
		...
		/* declared in midgard/mali_kbase_config.h but defined in platform folder */
	if (config == NULL) {
