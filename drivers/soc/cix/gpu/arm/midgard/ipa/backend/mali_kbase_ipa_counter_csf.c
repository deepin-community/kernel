...
#else
	SC_COUNTER_DEF("exec_instr_fma", 79182, EXEC_INSTR_FMA),
	SC_COUNTER_DEF("exec_instr_msg", 1433172, EXEC_INSTR_MSG),
	SC_COUNTER_DEF("beats_rd_tex", 100325, BEATS_RD_TEX),
	SC_COUNTER_DEF("beats_rd_lsc_ext", -379743, BEATS_RD_LSC_EXT),
	SC_COUNTER_DEF("frag_quads_coarse", 36786, FRAG_QUADS_COARSE),
	SC_COUNTER_DEF("ls_mem_write_short", 150369, LS_MEM_WRITE_SHORT),
	SC_COUNTER_DEF("beats_rd_tex_ext", -729947, BEATS_RD_TEX_EXT),
	SC_COUNTER_DEF("exec_instr_sfu", 692655, EXEC_INSTR_SFU),

	TILER_COUNTER_DEF("primassy_stall", -113320, PRIMASSY_STALL),
	TILER_COUNTER_DEF("idvs_var_shad_stall", -24878, IDVS_VAR_SHAD_STALL),
	MEMSYS_COUNTER_DEF("l2_rd_msg_in_cu", 2481397, L2_RD_MSG_IN_CU),
	MEMSYS_COUNTER_DEF("l2_snp_msg_in", -2205242, L2_SNP_MSG_IN),
	MEMSYS_COUNTER_DEF("l2_ext_read_nosnp", 2440743, L2_EXT_READ_NOSNP),
#endif
};
