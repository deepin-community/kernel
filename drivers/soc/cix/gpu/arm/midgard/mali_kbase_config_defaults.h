...
#else
#define IPA_CONTROL_TIMER_DEFAULT_VALUE_MS ((u32)5) /* 5 milliseconds */
...
/* TODO: This is just a workaround change for DPTSW-13014 issue.
 * GPU may experience high latency when setting  the GLB_ALLOC_EN register
 * in certain extreme scenarios.
 * Appropriately increasing this latency can avoid GPU reset issues.
 */
#define CSF_PM_TIMEOUT_CYCLES (500000000)
...
#else
#ifdef USING_DOCKER_MODE
#define KCPU_FENCE_SIGNAL_TIMEOUT_CYCLES (20000000000ull)
#define KCPU_FENCE_SIGNAL_TIMEOUT_CYCLES_FPGA (50000000000ull)
#else
