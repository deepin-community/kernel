...
static int __init cix_scmi_em_init(void)
{
	return cix_scmi_driver_register(&cix_scmi_em_drv, THIS_MODULE, KBUILD_MODNAME);
}

//module_scmi_driver(cix_scmi_em_drv);
module_init(cix_scmi_em_init);
