...
static inline S8 const *mgrEvtCodeTrans(U32 opCode)
{
    U32 typeIndex = 0;
    U32 codeIndex = 0;
    const S8* pEvtTransStr = NULL;
    static S8 const *pEvtCodeInfo[PS3_EVT_MAX_TYPE_LOCAL][MGR_EVT_TYPE_OFFSET] = {
        {
            "MGR_EVT_SAS_START",
    ...
    if (opCode >= ((MGR_EVT_EXTEND_TYPE_START - 1) * MGR_EVT_TYPE_OFFSET) + \
            (PS3_EVT_MAX_TYPE_LOCAL - MGR_EVT_EXTEND_TYPE_START) * MGR_EVT_TYPE_EXTEND_OFFSET) {
        goto end;
    };
